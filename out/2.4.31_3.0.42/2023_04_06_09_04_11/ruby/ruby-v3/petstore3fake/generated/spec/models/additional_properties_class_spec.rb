...
# Unit tests for SwaggerClient::AdditionalPropertiesClass
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AdditionalPropertiesClass' do
  before do
    # run before each test
    @instance = SwaggerClient::AdditionalPropertiesClass.new
  end
  ...
  describe 'test an instance of AdditionalPropertiesClass' do
    it 'should create an instance of AdditionalPropertiesClass' do
      expect(@instance).to be_instance_of(SwaggerClient::AdditionalPropertiesClass)
    end
  end
