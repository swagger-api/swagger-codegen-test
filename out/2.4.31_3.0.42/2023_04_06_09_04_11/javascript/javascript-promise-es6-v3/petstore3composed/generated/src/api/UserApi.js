...
export class UserApi {
    ...
    */
     ...
     * Create user
     * This can only be done by the logged in user.
     * @param {<&vendorExtensions.x-jsdoc-type>} body Created user object
    ...
    /**
     * Creates list of users with given input array
     * @param {<&vendorExtensions.x-jsdoc-type>} body List of user object
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    ...
    /**
     * Logs user into the system
     * @param {<&vendorExtensions.x-jsdoc-type>} username The user name for login
     * @param {<&vendorExtensions.x-jsdoc-type>} password The password for login in clear text
     ...
     * Updated user
     * This can only be done by the logged in user.
     * @param {<&vendorExtensions.x-jsdoc-type>} body Updated user object
     * @param {<&vendorExtensions.x-jsdoc-type>} username name that need to be updated
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    userUsernamePut(body, username) {
      return this.userUsernamePutWithHttpInfo(body, username)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
