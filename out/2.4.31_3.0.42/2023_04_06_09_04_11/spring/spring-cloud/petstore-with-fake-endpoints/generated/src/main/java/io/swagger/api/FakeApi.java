...
public interface FakeApi {
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Boolean>> fakeOuterBooleanSerialize(@ApiParam(value = "Input boolean as post body"  )  @Valid @RequestBody Boolean body);
    ...
    @RequestMapping(value = "/fake/outer/composite",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<OuterComposite>> fakeOuterCompositeSerialize(@ApiParam(value = "Input composite as post body"  )  @Valid @RequestBody OuterComposite body);
    ...
    @RequestMapping(value = "/fake/outer/number",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<BigDecimal>> fakeOuterNumberSerialize(@ApiParam(value = "Input number as post body"  )  @Valid @RequestBody BigDecimal body);
    ...
    @RequestMapping(value = "/fake/outer/string",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<String>> fakeOuterStringSerialize(@ApiParam(value = "Input string as post body"  )  @Valid @RequestBody String body);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testBodyWithQueryParams(@ApiParam(value = "" ,required=true )  @Valid @RequestBody User body,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "query", required = true) String query);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Client>> testClientModel(@ApiParam(value = "client model" ,required=true )  @Valid @RequestBody Client body);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testEnumParameters(@ApiParam(value = "Form parameter enum test (string array)" , allowableValues="{values=[>, $], enumVars=[{name=GREATER_THAN, value=">"}, {name=DOLLAR, value="$"}]}") @RequestParam(value="enum_form_string_array", required=false)  List<String> enumFormStringArray,@ApiParam(value = "Form parameter enum test (string)" , allowableValues="{values=[_abc, -efg, (xyz)], enumVars=[{name=_ABC, value="_abc"}, {name=_EFG, value="-efg"}, {name=_XYZ_, value="(xyz)"}]}", defaultValue="-efg") @RequestParam(value="enum_form_string", required=false)  String enumFormString,@ApiParam(value = "Header parameter enum test (string array)" , allowableValues=">, $") @RequestHeader(value="enum_header_string_array", required=false) List<String> enumHeaderStringArray,@ApiParam(value = "Header parameter enum test (string)" , allowableValues="_abc, -efg, (xyz)", defaultValue="-efg") @RequestHeader(value="enum_header_string", required=false) String enumHeaderString,@ApiParam(value = "Query parameter enum test (string array)", allowableValues = ">, $") @Valid @RequestParam(value = "enum_query_string_array", required = false) List<String> enumQueryStringArray,@ApiParam(value = "Query parameter enum test (string)", allowableValues = "_abc, -efg, (xyz)", defaultValue = "-efg") @Valid @RequestParam(value = "enum_query_string", required = false, defaultValue="-efg") String enumQueryString,@ApiParam(value = "Query parameter enum test (double)", allowableValues = "1, -2") @Valid @RequestParam(value = "enum_query_integer", required = false) Integer enumQueryInteger,@ApiParam(value = "Query parameter enum test (double)" , allowableValues="{values=[1.1, -1.2], enumVars=[{name=NUMBER_1_DOT_1, value=1.1}, {name=NUMBER_MINUS_1_DOT_2, value=-1.2}]}") @RequestParam(value="enum_query_double", required=false)  Double enumQueryDouble);
    ...
    @RequestMapping(value = "/fake/inline-additionalProperties",
        consumes = "application/json",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testInlineAdditionalProperties(@ApiParam(value = "request body" ,required=true )  @Valid @RequestBody Object param);
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = "application/json",
        method = RequestMethod.GET)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testJsonFormData(@ApiParam(value = "field1", required=true ) @RequestParam(value="param", required=true)  String param,@ApiParam(value = "field2", required=true ) @RequestParam(value="param2", required=true)  String param2);
