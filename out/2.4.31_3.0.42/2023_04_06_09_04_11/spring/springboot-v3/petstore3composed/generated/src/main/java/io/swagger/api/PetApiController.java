...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2023-04-06T09:18:21.576Z[Etc/UTC]")
@RestController
public class PetApiController implements PetApi {
    ...
    public ResponseEntity<Void> feedPet(@Parameter(in = ParameterIn.HEADER, description = "status" ,required=true,schema=@Schema()) @RequestHeader(value="token", required=true) String token,@NotNull @Parameter(in = ParameterIn.QUERY, description = "type of food" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "petType", required = true) String petType,@NotNull @Parameter(in = ParameterIn.QUERY, description = "status" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "status", required = true) String status,@Parameter(in = ParameterIn.PATH, description = "ID of pet to return", required=true, schema=@Schema()) @PathVariable("petId") Long petId,@Parameter(in = ParameterIn.COOKIE, description = "session id" ,required=true,schema=@Schema()) @CookieValue(value="sessionId", required=true) String sessionId,@Parameter(in = ParameterIn.DEFAULT, description = "Pet object that needs to be added to the store", required=true, schema=@Schema()) @Valid @RequestBody Pet body) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
