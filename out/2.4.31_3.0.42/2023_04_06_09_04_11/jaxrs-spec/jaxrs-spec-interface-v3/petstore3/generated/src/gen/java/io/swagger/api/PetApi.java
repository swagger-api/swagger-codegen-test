...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-04-06T09:14:15.231Z[Etc/UTC]")
...
"read:pets"        })    }, tags={ "pet" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/xml", schema = @Schema(implementation = Pet.class))),
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    Pet addPet(@FormParam(value = "id")  Long id,@FormParam(value = "name")  String name,@FormParam(value = "category")  Category category,@FormParam(value = "photoUrls")  List<String> photoUrls,@FormParam(value = "tags")  List<Tag> tags,@FormParam(value = "status")  String status);
    @DELETE
    @Path("/{petId}")
...
"read:pets"        })    }, tags={ "pet" })
    ...
    List<Pet> findPetsByStatus(  @QueryParam("status") @DefaultValue("available") 
...
"read:pets"        })    }, tags={ "pet" })
    ...
    List<Pet> findPetsByTags(  @QueryParam("tags") 
...
"read:pets"        })    }, tags={ "pet" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Pet not found"),
        @ApiResponse(responseCode = "405", description = "Validation exception") })
    Pet updatePet(@FormParam(value = "id")  Long id,@FormParam(value = "name")  String name,@FormParam(value = "category")  Category category,@FormParam(value = "photoUrls")  List<String> photoUrls,@FormParam(value = "tags")  List<Tag> tags,@FormParam(value = "status")  String status);
    @POST
    @Path("/{petId}")
