...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-04-06T09:19:51.496Z[Etc/UTC]")
public interface FakeApi {
    ...
    Response testEndpointParameters(@Valid FakeBody body);
    @GET
    @Operation(summary = "To test enum parameters", description = "To test enum parameters", tags={ "fake" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "400", description = "Invalid request"),
        @ApiResponse(responseCode = "404", description = "Not found") })
    Response testEnumParameters(  @HeaderParam("enum_header_string_array") 
...
,  @QueryParam("enum_query_integer") 
 ...
 @Parameter(description = "Query parameter enum test (double)")  Integer enumQueryInteger
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "400", description = "Invalid request"),
        @ApiResponse(responseCode = "404", description = "Not found") })
    Response testEnumRequestBody(@Valid EnumFormBody body);
    @POST
    ...
    Response testInlineAdditionalProperties(@Valid Map<String, String> body);
    @POST
    @Path("/jsonFormData")
    @Consumes({ "application/json" })
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
    Response testJsonFormData(@Valid FakeJsonFormDataBody body);}
