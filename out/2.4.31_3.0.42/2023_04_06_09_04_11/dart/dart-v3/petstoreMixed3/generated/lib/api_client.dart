...
class ApiClient {
  ...
  ApiClient({this.basePath: "https://raw.githubusercontent.com/v3"}) {
  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'AllOfPupPetsItems':
          return new AllOfPupPetsItems.fromJson(value);
        ...
        case 'AnyOfparrotBodyParrotsItems':
          return new AnyOfparrotBodyParrotsItems.fromJson(value);
        case 'ApiResponse':
        ...
        case 'Macaw':
          return new Macaw.fromJson(value);
        case 'MapTest':
        ...
        case 'OneOfPartMasterDestination':
          return new OneOfPartMasterDestination.fromJson(value);
        case 'OneOfPartMasterOrigin':
          return new OneOfPartMasterOrigin.fromJson(value);
        case 'OneOfPup':
          return new OneOfPup.fromJson(value);
        case 'OneOfSinglePetResponsePet':
          return new OneOfSinglePetResponsePet.fromJson(value);
        case 'OneOfinlineResponse200ParrotsItems':
          return new OneOfinlineResponse200ParrotsItems.fromJson(value);
        case 'OneOfvalMembersValMemberItems':
          return new OneOfvalMembersValMemberItems.fromJson(value);
        case 'Order':
        ...
        case 'Parakeet':
          return new Parakeet.fromJson(value);
        case 'ParrotBody':
          return new ParrotBody.fromJson(value);
        case 'ParrotBody1':
          return new ParrotBody1.fromJson(value);
        case 'PartFour':
          return new PartFour.fromJson(value);
        case 'PartMaster':
          return new PartMaster.fromJson(value);
        case 'PartOne':
          return new PartOne.fromJson(value);
        case 'PartThree':
          return new PartThree.fromJson(value);
        case 'PartTwo':
          return new PartTwo.fromJson(value);
        case 'Pet':
        ...
        case 'UserWrapper':
          return new UserWrapper.fromJson(value);
        case 'Users':
          return new Users.fromJson(value);
        case 'ValMemberChoice1':
          return new ValMemberChoice1.fromJson(value);
        case 'ValMemberChoice2':
          return new ValMemberChoice2.fromJson(value);
        case 'ValMembers':
          return new ValMembers.fromJson(value);
        default:
          {
            Match match;
            if (value is List &&
