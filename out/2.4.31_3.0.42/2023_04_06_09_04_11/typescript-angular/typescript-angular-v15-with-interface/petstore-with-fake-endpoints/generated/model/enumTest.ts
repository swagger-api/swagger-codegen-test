...
export namespace EnumTest {
    ...
    export type EnumStringRequiredEnum = 'UPPER' | 'lower' | '';
    export const EnumStringRequiredEnum = {
        UPPER: 'UPPER' as EnumStringRequiredEnum,
        Lower: 'lower' as EnumStringRequiredEnum,
        Empty: '' as EnumStringRequiredEnum
    };
