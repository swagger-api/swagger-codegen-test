...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-01-25T10:40:06.304Z[Etc/UTC]")
public interface ParrotApi {
    ...
    InlineResponse2001 addParrot(@Valid ParrotBody1 body);
    @GET
    @Produces({ "application/json" })
    ...
    InlineResponse200 updateParrots(@Valid ParrotBody body);}
