...
class PetApi(
   ...
   * @return Pet
   */
  def addPet(body: Pet, id: Long, name: String, category: Category, photoUrls: List[String], tags: List[Tag], status: String): Option[Pet] = {
    val await = Try(Await.result(addPetAsync(body, id, name, category, photoUrls, tags, status), Duration.Inf))
    await match {
   ...
   * @return Future(Pet)
   */
  def addPetAsync(body: Pet, id: Long, name: String, category: Category, photoUrls: List[String], tags: List[Tag], status: String): Future[Pet] = {
      helper.addPet(body, id, name, category, photoUrls, tags, status)
  }
   ...
   * @return List[Pet]
   */
  def findPetsByStatus(status: Option[String] = Option("available")): Option[List[Pet]] = {
   ...
   */
  def findPetsByStatusAsync(status: Option[String] = Option("available")): Future[List[Pet]] = {
   ...
   * @return Pet
   */
  def updatePet(body: Pet, id: Long, name: String, category: Category, photoUrls: List[String], tags: List[Tag], status: String): Option[Pet] = {
    val await = Try(Await.result(updatePetAsync(body, id, name, category, photoUrls, tags, status), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(Pet)
   */
  def updatePetAsync(body: Pet, id: Long, name: String, category: Category, photoUrls: List[String], tags: List[Tag], status: String): Future[Pet] = {
      helper.updatePet(body, id, name, category, photoUrls, tags, status)
  }
...
class PetApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def addPet(body: Pet,
    ...
    tags: List[Tag],
    status: String)(implicit reader: ClientResponseReader[Pet], writer: RequestWriter[Pet]): Future[Pet] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling PetApi->addPet")

    if (category == null) throw new Exception("Missing required parameter 'category' when calling PetApi->addPet")
    if (photoUrls == null) throw new Exception("Missing required parameter 'photoUrls' when calling PetApi->addPet")
    if (tags == null) throw new Exception("Missing required parameter 'tags' when calling PetApi->addPet")
    if (status == null) throw new Exception("Missing required parameter 'status' when calling PetApi->addPet")
  ...
  def findPetsByStatus(status: Option[String] = Option("available")
  ...
  def updatePet(body: Pet,
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling PetApi->updatePet")

    if (category == null) throw new Exception("Missing required parameter 'category' when calling PetApi->updatePet")
    if (photoUrls == null) throw new Exception("Missing required parameter 'photoUrls' when calling PetApi->updatePet")
    if (tags == null) throw new Exception("Missing required parameter 'tags' when calling PetApi->updatePet")
    if (status == null) throw new Exception("Missing required parameter 'status' when calling PetApi->updatePet")
