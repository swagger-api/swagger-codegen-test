...
module SwaggerClient
  class Capitalization
    ...
    def self.openapi_types
      {
        :'small_camel' => :'Object',
        :'capital_camel' => :'Object',
        :'small_snake' => :'Object',
        :'capital_snake' => :'Object',
        :'sca_eth_flow_points' => :'Object',
        :'att_name' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Capitalization` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Capitalization`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
