...
public interface UserApi {
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<User>> createUser(@ApiParam(value = "Created user object" ) @Valid @RequestBody User body);
    ...
    @RequestMapping(value = "/user/createWithList",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<User>> createUsersWithListInput(@ApiParam(value = "" ) @Valid @RequestBody List<User> body);
    ...
    @RequestMapping(value = "/user/login",
        produces = "application/json", 
        method = RequestMethod.GET)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<String>> loginUser(@ApiParam(value = "The user name for login") @Valid @RequestParam(value = "username", required = false) String username, @ApiParam(value = "The password for login in clear text") @Valid @RequestParam(value = "password", required = false) String password);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> updateUser(@ApiParam(value = "name that need to be deleted", required=true) @PathVariable("username") String username, @ApiParam(value = "Update an existent user in the store" ) @Valid @RequestBody User body);
