...
public interface PetApi {
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Pet>> addPet(@ApiParam(value = "Create a new pet in the store", required=true ) @Valid @RequestBody Pet body);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<List<Pet>>> findPetsByStatus(@ApiParam(value = "Status values that need to be considered for filter", allowableValues="available, pending, sold"
, defaultValue = "available") @Valid @RequestParam(value = "status", required = false, defaultValue="available") String status);
    ...
    @RequestMapping(value = "/pet/findByTags",
        produces = "application/json", 
        method = RequestMethod.GET)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<List<Pet>>> findPetsByTags(@ApiParam(value = "Tags to filter by") @Valid @RequestParam(value = "tags", required = false) List<String> tags);
...
@Authorization(value = "petstore_auth", scopes = { 
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Pet>> updatePet(@ApiParam(value = "Update an existent pet in the store", required=true ) @Valid @RequestBody Pet body);
    ...
    @RequestMapping(value = "/pet/{petId}/uploadImage",
        ...
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<ModelApiResponse>> uploadFile(@ApiParam(value = "ID of pet to update", required=true) @PathVariable("petId") Long petId, @ApiParam(value = "Additional Metadata") @Valid @RequestParam(value = "additionalMetadata", required = false) String additionalMetadata, @ApiParam(value = "" ) @Valid @RequestBody Object body);
