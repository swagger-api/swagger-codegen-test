...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2023-01-17T18:07:20.452Z[Etc/UTC]")
@RestController
public class ParrotApiController implements ParrotApi {
    ...
    public ResponseEntity<InlineResponse2001> addParrot(@ApiParam(value = "" ) @Valid @RequestBody ParrotBody1 body) {
    ...
    public ResponseEntity<InlineResponse200> updateParrots(@ApiParam(value = "" ) @Valid @RequestBody ParrotBody body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
