...
class UserApi(
   ...
   * @return User
   */
  def createUser(body: Option[User] = None, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None): Option[User] = {
    val await = Try(Await.result(createUserAsync(body, id, username, firstName, lastName, email, password, phone, userStatus), Duration.Inf))
    await match {
   ...
   * @return Future(User)
   */
  def createUserAsync(body: Option[User] = None, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None): Future[User] = {
      helper.createUser(body, id, username, firstName, lastName, email, password, phone, userStatus)
  }
   ...
   * @return void
   */
  def updateUser(username: String, body: Option[User] = None, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None) = {
    val await = Try(Await.result(updateUserAsync(username, body, id, username, firstName, lastName, email, password, phone, userStatus), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(void)
   */
  def updateUserAsync(username: String, body: Option[User] = None, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None) = {
      helper.updateUser(username, body, id, username, firstName, lastName, email, password, phone, userStatus)
  }
...
class UserApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def updateUser(username: String,
    ...
    phone: Option[String] = None,
    userStatus: Option[Integer] = None
    )(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[Option[User]]): Future[Unit] = {
    // create path and map variables
    val path = (addFmt("/user/{username}")
      replaceAll("\\{" + "username" + "\\}", username.toString))
