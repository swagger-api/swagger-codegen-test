...
class AllOfPupPetsItems(Pet):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfPupPetsItems - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfPupPetsItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfPupPetsItems):
            return False
