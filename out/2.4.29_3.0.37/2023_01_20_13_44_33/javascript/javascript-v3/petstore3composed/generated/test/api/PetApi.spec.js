  ...
  describe('PetApi', function() {
    ...
    describe('doCategoryStuff', function() {
      it('should call doCategoryStuff successfully', function(done) {
        //uncomment below and update the code to test doCategoryStuff
        //instance.doCategoryStuff(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('feedPet', function() {
      it('should call feedPet successfully', function(done) {
        //uncomment below and update the code to test feedPet
        //instance.feedPet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
