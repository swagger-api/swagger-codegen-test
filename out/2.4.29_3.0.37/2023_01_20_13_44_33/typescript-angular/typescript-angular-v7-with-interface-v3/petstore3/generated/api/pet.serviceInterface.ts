...
export interface PetServiceInterface {
    ...
    * @param status 
    */
    addPet(body: Pet, id: number, name: string, category: Category, photoUrls: Array<string>, tags: Array<Tag>, status: string, extraHttpRequestParams?: any): Observable<Pet>;
    ...
    * @param status 
    */
    updatePet(body: Pet, id: number, name: string, category: Category, photoUrls: Array<string>, tags: Array<Tag>, status: string, extraHttpRequestParams?: any): Observable<Pet>;
