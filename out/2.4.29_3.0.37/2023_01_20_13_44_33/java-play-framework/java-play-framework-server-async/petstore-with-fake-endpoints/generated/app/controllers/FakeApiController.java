...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaPlayFrameworkCodegen", date = "2023-01-20T13:56:58.109Z")
...
public class FakeApiController extends Controller {
    ...
    @ApiAction
    public CompletionStage<Result> fakeOuterBooleanSerialize() throws Exception {
        ...
        CompletionStage<Boolean> stage = imp.fakeOuterBooleanSerialize(body).thenApply(obj -> { 
            return obj;
        });
        stage.thenApply(obj -> {
    ...
    @ApiAction
    public CompletionStage<Result> fakeOuterCompositeSerialize() throws Exception {
        JsonNode nodebody = request().body().asJson();
        OuterComposite body;
        if (nodebody != null) {
        ...
        CompletionStage<OuterComposite> stage = imp.fakeOuterCompositeSerialize(body).thenApply(obj -> { 
    ...
    @ApiAction
    public CompletionStage<Result> fakeOuterNumberSerialize() throws Exception {
        JsonNode nodebody = request().body().asJson();
        BigDecimal body;
        if (nodebody != null) {
        ...
        CompletionStage<BigDecimal> stage = imp.fakeOuterNumberSerialize(body).thenApply(obj -> { 
            if (configuration.getBoolean("useOutputBeanValidation")) {
                SwaggerUtils.validate(obj);
            }
            return obj;
    ...
    @ApiAction
    public CompletionStage<Result> fakeOuterStringSerialize() throws Exception {
        JsonNode nodebody = request().body().asJson();
        String body;
        if (nodebody != null) {
        ...
        CompletionStage<String> stage = imp.fakeOuterStringSerialize(body).thenApply(obj -> { 
            return obj;
        });
        stage.thenApply(obj -> {
            JsonNode result = mapper.valueToTree(obj);
    ...
    @ApiAction
    public CompletionStage<Result> testBodyWithQueryParams() throws Exception {
        JsonNode nodebody = request().body().asJson();
        User body;
        if (nodebody != null) {
    ...
    @ApiAction
    public CompletionStage<Result> testClientModel() throws Exception {
        JsonNode nodebody = request().body().asJson();
        Client body;
        if (nodebody != null) {
        ...
        CompletionStage<Client> stage = imp.testClientModel(body).thenApply(obj -> { 
            if (configuration.getBoolean("useOutputBeanValidation")) {
                SwaggerUtils.validate(obj);
            }
            return obj;
    ...
    @ApiAction
    public CompletionStage<Result> testEndpointParameters() throws Exception {
    ...
    @ApiAction
    public CompletionStage<Result> testEnumParameters() throws Exception {
    ...
    @ApiAction
    public CompletionStage<Result> testInlineAdditionalProperties() throws Exception {
    ...
    @ApiAction
    public CompletionStage<Result> testJsonFormData() throws Exception {
