...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath="https://raw.githubusercontent.com/v3")
        {
            BasePath = basePath;
            ...
            foreach (string auth in authSettings)
            {
                ...
                switch(auth)
                {
                    case "api_key":
                        ...
                        break;
                    case "api_key_query":
                        queryParams["api_key_query"] = GetApiKeyWithPrefix("api_key_query");
                        
                        break;
                    case "http_basic_test":
                        headerParams["Authorization"] = "Basic " + Base64Encode(Configuration.Username + ":" + Configuration.Password);
                        
                        break;
                    case "http_bearer_test":
