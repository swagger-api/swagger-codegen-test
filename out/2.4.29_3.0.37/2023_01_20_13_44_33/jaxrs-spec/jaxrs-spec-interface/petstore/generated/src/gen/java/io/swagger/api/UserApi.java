...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2023-01-20T13:50:16.397Z")
public interface UserApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "User not found", response = Void.class) })
    void updateUser(@PathParam("username") @ApiParam("name that need to be updated") String username,@Valid User body);
}
