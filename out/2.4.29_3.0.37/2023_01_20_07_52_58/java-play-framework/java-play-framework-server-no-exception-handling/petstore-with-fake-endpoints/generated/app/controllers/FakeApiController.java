...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaPlayFrameworkCodegen", date = "2023-01-20T08:06:40.444Z")
...
public class FakeApiController extends Controller {
    ...
    @ApiAction
    public Result fakeOuterBooleanSerialize() throws IOException {
    ...
    @ApiAction
    public Result fakeOuterCompositeSerialize() throws IOException {
        JsonNode nodebody = request().body().asJson();
        OuterComposite body;
        if (nodebody != null) {
    ...
    @ApiAction
    public Result fakeOuterNumberSerialize() throws IOException {
        JsonNode nodebody = request().body().asJson();
        BigDecimal body;
        if (nodebody != null) {
    ...
    @ApiAction
    public Result fakeOuterStringSerialize() throws IOException {
        JsonNode nodebody = request().body().asJson();
        String body;
        if (nodebody != null) {
    ...
    @ApiAction
    public Result testBodyWithQueryParams() throws IOException {
        JsonNode nodebody = request().body().asJson();
        User body;
        if (nodebody != null) {
    ...
    @ApiAction
    public Result testClientModel() throws IOException {
        JsonNode nodebody = request().body().asJson();
        Client body;
        if (nodebody != null) {
    ...
    @ApiAction
    public Result testEndpointParameters()  {
    ...
    @ApiAction
    public Result testEnumParameters()  {
    ...
    @ApiAction
    public Result testInlineAdditionalProperties() throws IOException {
    ...
    @ApiAction
    public Result testJsonFormData()  {
