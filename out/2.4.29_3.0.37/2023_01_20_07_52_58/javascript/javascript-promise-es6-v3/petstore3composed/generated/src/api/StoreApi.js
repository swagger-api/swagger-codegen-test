...
export class StoreApi {
    ...
    */
     ...
     * Delete purchase order by ID
     * For valid response try integer IDs with positive integer value.\\ \\ Negative or non-integer values will generate API errors
     * @param {<&vendorExtensions.x-jsdoc-type>} orderId ID of the order that needs to be deleted
     ...
     * Find purchase order by ID
     * For valid response try integer IDs with value &gt;&#x3D; 1 and &lt;&#x3D; 10.\\ \\ Other values will generated exceptions
     * @param {<&vendorExtensions.x-jsdoc-type>} orderId ID of pet that needs to be fetched
    ...
    /**
     * Place an order for a pet
     * @param {<&vendorExtensions.x-jsdoc-type>} body order placed for purchasing the pet
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Order}
     */
    placeOrder(body) {
