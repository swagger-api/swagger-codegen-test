...
namespace IO.Swagger.Api
{
    ...
    public interface IStoreApi
    {
        ...
        /// <returns>Order</returns>
        Order PlaceOrder (long? id, long? petId, int? quantity, DateTime? shipDate, string status, bool? complete);
    }
    ...
    public class StoreApi : IStoreApi
    {
        ...
        /// <param name="complete"></param>
        /// <returns>Order</returns>
        public Order PlaceOrder (long? id, long? petId, int? quantity, DateTime? shipDate, string status, bool? complete)
        {
...
if (petId != null) formParams.Add("petId", ApiClient.ParameterToString(petId)); // form parameter
if (quantity != null) formParams.Add("quantity", ApiClient.ParameterToString(quantity)); // form parameter
if (shipDate != null) formParams.Add("shipDate", ApiClient.ParameterToString(shipDate)); // form parameter
if (status != null) formParams.Add("status", ApiClient.ParameterToString(status)); // form parameter
if (complete != null) formParams.Add("complete", ApiClient.ParameterToString(complete)); // form parameter
