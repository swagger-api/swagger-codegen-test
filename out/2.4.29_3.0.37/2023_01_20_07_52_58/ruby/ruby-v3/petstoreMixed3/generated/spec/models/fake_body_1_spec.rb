...
# Unit tests for SwaggerClient::FakeBody1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FakeBody1' do
  before do
    # run before each test
    @instance = SwaggerClient::FakeBody1.new
  end
  ...
  describe 'test an instance of FakeBody1' do
    it 'should create an instance of FakeBody1' do
      expect(@instance).to be_instance_of(SwaggerClient::FakeBody1)
    end
  end
