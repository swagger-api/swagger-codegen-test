...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-01-20T08:13:50.828Z[Etc/UTC]")
public interface UserApi {
 ...
 @Parameter(description = "The name that needs to be fetched. Use user1 for testing.") String username
    ...
    Response loginUser( @NotNull  @QueryParam("username") 
...
, @NotNull  @QueryParam("password") 
 ...
 @Parameter(description = "The password for login in clear text")  String password
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "User not found") })
    Response userUsernamePut(@Valid User body, @PathParam("username")
