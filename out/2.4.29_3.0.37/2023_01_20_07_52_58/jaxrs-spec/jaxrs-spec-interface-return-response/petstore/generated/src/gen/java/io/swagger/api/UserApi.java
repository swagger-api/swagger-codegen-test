...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2023-01-20T08:03:38.319Z")
public interface UserApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "User not found", response = Void.class) })
    Response updateUser(@PathParam("username") @ApiParam("name that need to be updated") String username,@Valid User body);
}
