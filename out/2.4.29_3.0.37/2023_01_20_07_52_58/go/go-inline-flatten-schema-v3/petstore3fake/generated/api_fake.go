...
*/
func (a *FakeApiService) TestEndpointParameters(ctx context.Context, body FakeBody) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *FakeApiTestEnumRequestBodyOpts - Optional Parameters:
     * @param "Body" (optional.Interface of EnumFormBody) - 
...
*/
func (a *FakeApiService) TestJsonFormData(ctx context.Context, body FakeJsonFormDataBody) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
