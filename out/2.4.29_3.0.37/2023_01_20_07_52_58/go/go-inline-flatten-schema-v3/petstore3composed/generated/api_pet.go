...
/*
PetApiService Add a new parrow to the store
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PetApiAddParrotOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ParrotBody1) - 
@return InlineResponse2001
*/

type PetApiAddParrotOpts struct {
    Body optional.Interface
}

func (a *PetApiService) AddParrot(ctx context.Context, localVarOptionals *PetApiAddParrotOpts) (InlineResponse2001, *http.Response, error) {
	var (
...
*/
func (a *PetApiService) FeedPet(ctx context.Context, body Pet, token string, petType string, status string, petId int64, sessionId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/pet/feed/{petId}"
	localVarPath = strings.Replace(localVarPath, "{"+"petId"+"}", fmt.Sprintf("%v", petId), -1)
	...
	localVarQueryParams.Add("petType", parameterToString(petType, ""))
...
/*
PetApiService get Parrots
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []InlineResponseItems200
*/
func (a *PetApiService) GetParrots(ctx context.Context) ([]InlineResponseItems200, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
PetApiService update parrots
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PetApiUpdateParrotsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ParrotBody) - 
@return InlineResponse200
*/

type PetApiUpdateParrotsOpts struct {
    Body optional.Interface
}

func (a *PetApiService) UpdateParrots(ctx context.Context, localVarOptionals *PetApiUpdateParrotsOpts) (InlineResponse200, *http.Response, error) {
	var (
