...
import io.swagger.server.models.ParrotBody
import io.swagger.server.models.ParrotBody1
...
fun Route.PetApi() {
    ...
    post<Paths.addParrot> {  _: Paths.addParrot ->
    ...
    post<Paths.doCategoryStuff> {  _: Paths.doCategoryStuff ->
        val exampleContentType = "application/json"
        val exampleContentString = """{
  "code" : 0,
  "type" : "type",
  "message" : "message"
    ...
    post<Paths.feedPet> {  _: Paths.feedPet ->
        call.respond(HttpStatusCode.NotImplemented)
    }
  ...
  "status" : "available"
    ...
    get<Paths.getParrots> {  _: Paths.getParrots ->
        val exampleContentType = "application/json"
        val exampleContentString = """[ "", "" ]"""
  ...
  "status" : "available"
    ...
    put<Paths.updateParrots> {  _: Paths.updateParrots ->
        val exampleContentType = "application/json"
        val exampleContentString = """{
  "parrots" : [ "", "" ]
}"""
