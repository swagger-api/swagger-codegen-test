...
class FakeApi
{
     ...
     *
     * @param  \Swagger\Client\Model\FakeBody $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Fake endpoint for testing various parameters 假端點 偽のエンドポイント 가짜 엔드 포인트
     *
     * @param  \Swagger\Client\Model\FakeBody $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return void
     */
    public function testEnumParameters($enum_header_string_array = null, $enum_header_string = '-efg', $enum_query_string_array = null, $enum_query_string = '-efg', $enum_query_integer = null)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function testEnumParametersWithHttpInfo($enum_header_string_array = null, $enum_header_string = '-efg', $enum_query_string_array = null, $enum_query_string = '-efg', $enum_query_integer = null)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testEnumParametersAsync($enum_header_string_array = null, $enum_header_string = '-efg', $enum_query_string_array = null, $enum_query_string = '-efg', $enum_query_integer = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testEnumParametersAsyncWithHttpInfo($enum_header_string_array = null, $enum_header_string = '-efg', $enum_query_string_array = null, $enum_query_string = '-efg', $enum_query_integer = null)
    {
        $returnType = '';
        $request = $this->testEnumParametersRequest($enum_header_string_array, $enum_header_string, $enum_query_string_array, $enum_query_string, $enum_query_integer);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testEnumParametersRequest($enum_header_string_array = null, $enum_header_string = '-efg', $enum_query_string_array = null, $enum_query_string = '-efg', $enum_query_integer = null)
    {
    ...
    /**
     * Operation testEnumRequestBody
     *
     * To test enum parameters
     *
     * @param  \Swagger\Client\Model\EnumFormBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function testEnumRequestBody($body = null)
    {
        $this->testEnumRequestBodyWithHttpInfo($body);
    }

    /**
     * Operation testEnumRequestBodyWithHttpInfo
     *
     * To test enum parameters
     *
     * @param  \Swagger\Client\Model\EnumFormBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function testEnumRequestBodyWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->testEnumRequestBodyRequest($body);
    ...
    /**
     * Operation testEnumRequestBodyAsync
     *
     * To test enum parameters
     *
     * @param  \Swagger\Client\Model\EnumFormBody $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testEnumRequestBodyAsync($body = null)
    {
        return $this->testEnumRequestBodyAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testEnumRequestBodyAsyncWithHttpInfo
     *
     * To test enum parameters
     *
     * @param  \Swagger\Client\Model\EnumFormBody $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testEnumRequestBodyAsyncWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->testEnumRequestBodyRequest($body);
    ...
    /**
     * Create request for operation 'testEnumRequestBody'
     *
     * @param  \Swagger\Client\Model\EnumFormBody $body (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testEnumRequestBodyRequest($body = null)
    {

        $resourcePath = '/fake/enum/form';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
