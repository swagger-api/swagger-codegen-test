...
public interface FakeApi {
    ...
    @RequestMapping(value = "/fake",
        ...
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testEndpointParameters(@ApiParam(value = "", required=true ) @Valid @RequestBody FakeBody body);
    ...
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testEnumParameters(@ApiParam(value = "Header parameter enum test (string array)" , allowableValues=">, $"
...
, defaultValue = "-efg") @Valid @RequestParam(value = "enum_query_string", required = false, defaultValue="-efg") String enumQueryString, @ApiParam(value = "Query parameter enum test (double)", allowableValues="1, -2"
    ...
    @RequestMapping(value = "/fake/enum/form",
        consumes = "*/*",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testEnumRequestBody(@ApiParam(value = "" ) @Valid @RequestBody EnumFormBody body);
    ...
    @RequestMapping(value = "/fake/inline-additionalProperties",
        consumes = "application/json",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testInlineAdditionalProperties(@ApiParam(value = "request body", required=true ) @Valid @RequestBody Map<String, String> body);
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = "application/json",
        method = RequestMethod.POST)
    com.netflix.hystrix.HystrixCommand<ResponseEntity<Void>> testJsonFormData(@ApiParam(value = "", required=true ) @Valid @RequestBody FakeJsonFormDataBody body);
