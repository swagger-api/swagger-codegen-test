...
# Unit tests for SwaggerClient::MixedPropertiesAndAdditionalPropertiesClass
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MixedPropertiesAndAdditionalPropertiesClass' do
  before do
    # run before each test
    @instance = SwaggerClient::MixedPropertiesAndAdditionalPropertiesClass.new
  end
  ...
  describe 'test an instance of MixedPropertiesAndAdditionalPropertiesClass' do
    it 'should create an instance of MixedPropertiesAndAdditionalPropertiesClass' do
      expect(@instance).to be_instance_of(SwaggerClient::MixedPropertiesAndAdditionalPropertiesClass)
    end
  end
