...
class ArrayTest {
  ...
  ArrayTest.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    arrayOfString = (json['array_of_string'] as List).map((item) => item as String).toList();
    arrayArrayOfInteger = List.listFromJson(json['array_array_of_integer']);
    arrayArrayOfModel = List.listFromJson(json['array_array_of_model']);
  }
