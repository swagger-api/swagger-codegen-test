...
public class StoreApi {
    ...
    public Response deleteOrder( @PathParam("orderId")
 ...
 @Parameter(description = "ID of the order that needs to be deleted") Long orderId
    ...
    public Response getOrderById( @PathParam("orderId")
 ...
 @Parameter(description = "ID of order that needs to be fetched") Long orderId
    ...
    public Response placeOrder(@FormParam(value = "id")  Long id,@FormParam(value = "petId")  Long petId,@FormParam(value = "quantity")  Integer quantity,@FormParam(value = "shipDate")  DateTime shipDate,@FormParam(value = "status")  String status,@FormParam(value = "complete")  Boolean complete) {
        return Response.ok().entity("magic!").build();
    }}
