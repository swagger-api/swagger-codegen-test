...
class PetApi(object):
    ...
    def feed_pet(self, body, token, pet_type, status, pet_id, session_id, **kwargs):  # noqa: E501
        """Find pet by ID  # noqa: E501

        schedule pet feeding  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_pet(body, token, pet_type, status, pet_id, session_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Pet body: Pet object that needs to be added to the store (required)
        :param str token: status (required)
        :param str pet_type: type of food (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.feed_pet_with_http_info(body, token, pet_type, status, pet_id, session_id, **kwargs)  # noqa: E501
        else:
            (data) = self.feed_pet_with_http_info(body, token, pet_type, status, pet_id, session_id, **kwargs)  # noqa: E501
            return data

    def feed_pet_with_http_info(self, body, token, pet_type, status, pet_id, session_id, **kwargs):  # noqa: E501
        """Find pet by ID  # noqa: E501

        schedule pet feeding  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_pet_with_http_info(body, token, pet_type, status, pet_id, session_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'token', 'pet_type', 'status', 'pet_id', 'session_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `feed_pet`")  # noqa: E501
        # verify the required parameter 'token' is set
        if ('token' not in params or
                params['token'] is None):
            raise ValueError("Missing the required parameter `token` when calling `feed_pet`")  # noqa: E501
        # verify the required parameter 'pet_type' is set
        if ('pet_type' not in params or
                params['pet_type'] is None):
            raise ValueError("Missing the required parameter `pet_type` when calling `feed_pet`")  # noqa: E501
        # verify the required parameter 'status' is set
        if ('status' not in params or
                params['status'] is None):
            raise ValueError("Missing the required parameter `status` when calling `feed_pet`")  # noqa: E501
        # verify the required parameter 'pet_id' is set
        if ('pet_id' not in params or
                params['pet_id'] is None):
            raise ValueError("Missing the required parameter `pet_id` when calling `feed_pet`")  # noqa: E501
        # verify the required parameter 'session_id' is set
        if ('session_id' not in params or
                params['session_id'] is None):
            raise ValueError("Missing the required parameter `session_id` when calling `feed_pet`")  # noqa: E501
        ...
        if 'pet_type' in params:
            query_params.append(('petType', params['pet_type']))  # noqa: E501
        if 'status' in params:
