...
import io.swagger.server.models.AllPetsResponse
import io.swagger.server.models.ApiResponse
import io.swagger.server.models.Pet
import io.swagger.server.models.SinglePetResponse
...
fun Route.PetApi() {
  ...
  "status" : "available"
    ...
    get<Paths.getAllPets> {  _: Paths.getAllPets ->
        val principal = call.authentication.principal<UserIdPrincipal>()
        if (principal == null) {
            call.respond(HttpStatusCode.Unauthorized)
        } else {
  ...
  "status" : "available"
    ...
    get<Paths.getRandomPet> {  _: Paths.getRandomPet ->
        val principal = call.authentication.principal<UserIdPrincipal>()
        if (principal == null) {
            call.respond(HttpStatusCode.Unauthorized)
        } else {
