...
class StoreApi(
   ...
   * @return Order
   */
  def placeOrder(body: Option[Order] = None, id: Option[Long] = None, petId: Option[Long] = None, quantity: Option[Integer] = None, shipDate: Option[Date] = None, status: Option[String] = None, complete: Option[Boolean] = None): Option[Order] = {
    val await = Try(Await.result(placeOrderAsync(body, id, petId, quantity, shipDate, status, complete), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(Order)
   */
  def placeOrderAsync(body: Option[Order] = None, id: Option[Long] = None, petId: Option[Long] = None, quantity: Option[Integer] = None, shipDate: Option[Date] = None, status: Option[String] = None, complete: Option[Boolean] = None): Future[Order] = {
      helper.placeOrder(body, id, petId, quantity, shipDate, status, complete)
  }
...
class StoreApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def placeOrder(body: Option[Order] = None,
    ...
    )(implicit reader: ClientResponseReader[Order], writer: RequestWriter[Option[Order]]): Future[Order] = {
    // create path and map variables
