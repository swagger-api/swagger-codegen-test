...
public interface UserApi {
  ...
  @POST("/user")
  void createUser(
    @retrofit.http.Body User body, Callback<User> cb
  );
  /**
   * Create user
   * Sync method
  ...
  @PUT("/user/{username}")
  Void updateUser(
    @retrofit.http.Path("username") String username, @retrofit.http.Field("id") Long id, @retrofit.http.Field("username") String username2, @retrofit.http.Field("firstName") String firstName, @retrofit.http.Field("lastName") String lastName, @retrofit.http.Field("email") String email, @retrofit.http.Field("password") String password, @retrofit.http.Field("phone") String phone, @retrofit.http.Field("userStatus") Integer userStatus
  );
