...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-04-02T19:53:27.938Z")
public class StoreApi {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public void deleteOrder(Long orderId, Map<String, Object> params) throws IOException {
        deleteOrderForHttpResponse(orderId, params);
    }

    public HttpResponse deleteOrderForHttpResponse(Long orderId) throws IOException {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/store/order/{orderId}");
    ...
    public HttpResponse deleteOrderForHttpResponse(Long orderId, Map<String, Object> params) throws IOException {
        // verify the required parameter 'orderId' is set
        if (orderId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'orderId' when calling deleteOrder");
        }
