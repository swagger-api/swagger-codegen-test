...
opts = { 
  body: SwaggerClient::OuterBoolean.new # OuterBoolean | Input boolean as post body
}
...
opts = { 
  body: SwaggerClient::OuterNumber.new # OuterNumber | Input number as post body
}
...
opts = { 
  body: SwaggerClient::OuterString.new # OuterString | Input string as post body
}
