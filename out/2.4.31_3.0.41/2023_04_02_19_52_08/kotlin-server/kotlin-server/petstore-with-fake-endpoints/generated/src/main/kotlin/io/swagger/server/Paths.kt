...
object Paths {
     ...
     */
    @Location("/fake") class testEnumParameters(val enumFormStringArray: kotlin.Array<kotlin.String>, val enumFormString: kotlin.String, val enumHeaderStringArray: kotlin.Array<kotlin.String>, val enumHeaderString: kotlin.String, val enumQueryStringArray: kotlin.Array<kotlin.String>, val enumQueryString: kotlin.String, val enumQueryInteger: kotlin.Int, val enumQueryDouble: kotlin.Double)
     ...
     * @param param2 field2 
     */
    @Location("/fake/jsonFormData") class testJsonFormData(val param: kotlin.String, val param2: kotlin.String)
     ...
     */
    @Location("/store/order/{order_id}") class deleteOrder(val orderId: kotlin.String)
     ...
     */
    @Location("/store/order/{order_id}") class getOrderById(val orderId: kotlin.Long)
