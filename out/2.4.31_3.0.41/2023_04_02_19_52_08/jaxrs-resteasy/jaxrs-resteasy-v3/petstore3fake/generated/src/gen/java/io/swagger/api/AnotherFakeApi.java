...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-04-02T20:03:04.882Z[Etc/UTC]")public class AnotherFakeApi  {
    ...
    public Response testSpecialTags(@Parameter(description = "client model" ,required=true) Client body,@Context SecurityContext securityContext)
