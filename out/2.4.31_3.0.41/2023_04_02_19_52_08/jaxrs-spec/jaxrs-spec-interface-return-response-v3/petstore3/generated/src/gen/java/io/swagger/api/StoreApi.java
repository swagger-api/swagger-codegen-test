...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-04-02T20:01:48.806Z[Etc/UTC]")
public interface StoreApi {
    ...
    Response deleteOrder( @PathParam("orderId")
 ...
 @Parameter(description = "ID of the order that needs to be deleted") Long orderId
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "Invalid ID supplied"),
        @ApiResponse(responseCode = "404", description = "Order not found") })
    Response getOrderById( @PathParam("orderId")
 ...
 @Parameter(description = "ID of order that needs to be fetched") Long orderId
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Order.class))),
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    Response placeOrder(@FormParam(value = "id")  Long id,@FormParam(value = "petId")  Long petId,@FormParam(value = "quantity")  Integer quantity,@FormParam(value = "shipDate")  Date shipDate,@FormParam(value = "status")  String status,@FormParam(value = "complete")  Boolean complete);}
