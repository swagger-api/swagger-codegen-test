...
class AllOfSubCategoryCategory(Model):
    ...
    """
    def __init__(self, id: int=None, name: str=None, subcategories: List[Category]=None, foo: bool=None, bar: int=None, beer: str=None, drunk: User=None):  # noqa: E501
        ...
        :type name: str
        :param subcategories: The subcategories of this AllOfSubCategoryCategory.  # noqa: E501
        :type subcategories: List[Category]
    ...
    def subcategories(self) -> List[Category]:
        """Gets the subcategories of this AllOfSubCategoryCategory.


        :return: The subcategories of this AllOfSubCategoryCategory.
        :rtype: List[Category]
        """
        return self._subcategories

    @subcategories.setter
    def subcategories(self, subcategories: List[Category]):
        """Sets the subcategories of this AllOfSubCategoryCategory.


        :param subcategories: The subcategories of this AllOfSubCategoryCategory.
        :type subcategories: List[Category]
        """
