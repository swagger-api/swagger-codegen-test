...
(function(root, factory) {
  ...
  describe('EnumFormBody', function() {
    it('should create an instance of EnumFormBody', function() {
      // uncomment below and update the code to test EnumFormBody
      //var instane = new SwaggerPetstore.EnumFormBody();
    ...
    it('should have the property enumQueryDouble (base name: "enum_query_double")', function() {
      // uncomment below and update the code to test the property enumQueryDouble
      //var instane = new SwaggerPetstore.EnumFormBody();
      //expect(instance).to.be();
    });
