...
class PetApi
{
    ...
    /**
     * Operation doCategoryStuff
     *
     * @param  \Swagger\Client\Model\SubCategory $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ApiResponse
     */
    public function doCategoryStuff($body = null)
    {
        list($response) = $this->doCategoryStuffWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation doCategoryStuffWithHttpInfo
     *
     * @param  \Swagger\Client\Model\SubCategory $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function doCategoryStuffWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ApiResponse';
        $request = $this->doCategoryStuffRequest($body);
    ...
    /**
     * Operation doCategoryStuffAsync
     *
     * 
     *
     * @param  \Swagger\Client\Model\SubCategory $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doCategoryStuffAsync($body = null)
    {
        return $this->doCategoryStuffAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation doCategoryStuffAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Swagger\Client\Model\SubCategory $body (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doCategoryStuffAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\ApiResponse';
        $request = $this->doCategoryStuffRequest($body);
    ...
    /**
     * Create request for operation 'doCategoryStuff'
     *
     * @param  \Swagger\Client\Model\SubCategory $body (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function doCategoryStuffRequest($body = null)
    {

        $resourcePath = '/pet/category';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AllPetsResponse
     */
    public function getAllPets()
    {
        list($response) = $this->getAllPetsWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAllPetsWithHttpInfo
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AllPetsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllPetsWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\AllPetsResponse';
        $request = $this->getAllPetsRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AllPetsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPetsAsync()
    {
        return $this->getAllPetsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllPetsAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPetsAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\AllPetsResponse';
        $request = $this->getAllPetsRequest();
    ...
    /**
     * Create request for operation 'getAllPets'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllPetsRequest()
    {

        $resourcePath = '/allPets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getRandomPet
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\SinglePetResponse
     */
    public function getRandomPet()
    {
        list($response) = $this->getRandomPetWithHttpInfo();
        return $response;
    }

    /**
     * Operation getRandomPetWithHttpInfo
     *
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\SinglePetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRandomPetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\SinglePetResponse';
        $request = $this->getRandomPetRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\SinglePetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRandomPetAsync()
    {
        return $this->getRandomPetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRandomPetAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRandomPetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\SinglePetResponse';
        $request = $this->getRandomPetRequest();
    ...
    /**
     * Create request for operation 'getRandomPet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRandomPetRequest()
    {

        $resourcePath = '/randomPet';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
