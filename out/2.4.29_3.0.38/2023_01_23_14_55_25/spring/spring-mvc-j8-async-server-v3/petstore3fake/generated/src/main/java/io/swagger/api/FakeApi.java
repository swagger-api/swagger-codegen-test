...
public interface FakeApi {
    ...
    @RequestMapping(value = "/fake",
        ...
        method = RequestMethod.POST)
    ResponseEntity<Void> testEndpointParameters(@ApiParam(value = "", required=true ) @Valid @RequestBody FakeBody body);
    ...
    ResponseEntity<Void> testEnumParameters(@ApiParam(value = "Header parameter enum test (string array)" , allowableValues=">, $"
...
, defaultValue = "-efg") @Valid @RequestParam(value = "enum_query_string", required = false, defaultValue="-efg") String enumQueryString, @ApiParam(value = "Query parameter enum test (double)", allowableValues="1, -2"
    ...
    @RequestMapping(value = "/fake/enum/form",
        consumes = { "*/*" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testEnumRequestBody(@ApiParam(value = "" ) @Valid @RequestBody EnumFormBody body);
    ...
    @RequestMapping(value = "/fake/jsonFormData",
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Void> testJsonFormData(@ApiParam(value = "", required=true ) @Valid @RequestBody FakeJsonFormDataBody body);
