...
# **getAllPets**
> \Swagger\Client\Model\AllPetsResponse getAllPets()
...
try {
    $result = $apiInstance->getAllPets();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PetApi->getAllPets: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\AllPetsResponse**](../Model/AllPetsResponse.md)
...
# **getRandomPet**
> \Swagger\Client\Model\SinglePetResponse getRandomPet()
...
try {
    $result = $apiInstance->getRandomPet();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PetApi->getRandomPet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Swagger\Client\Model\SinglePetResponse**](../Model/SinglePetResponse.md)
