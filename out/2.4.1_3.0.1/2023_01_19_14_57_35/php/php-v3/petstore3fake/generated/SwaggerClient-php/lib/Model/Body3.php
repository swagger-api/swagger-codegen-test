...
'callback' => 'getCallback'    ];
    ...
    public function setString($string)
    {
        ...
        if (!is_null($string) && (!preg_match("/[a-z]/i", $string))) {
            throw new \InvalidArgumentException("invalid value for $string when calling Body3., must conform to the pattern /[a-z]/i.");
        }
    ...
    public function setPatternWithoutDelimiter($pattern_without_delimiter)
    {
        ...
        if ((!preg_match("/^[A-Z].*/", $pattern_without_delimiter))) {
            throw new \InvalidArgumentException("invalid value for $pattern_without_delimiter when calling Body3., must conform to the pattern /^[A-Z].*/.");
        }
