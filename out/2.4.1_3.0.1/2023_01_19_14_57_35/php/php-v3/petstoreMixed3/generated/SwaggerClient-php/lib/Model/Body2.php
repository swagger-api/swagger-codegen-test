...
'callback' => 'getCallback'    ];
    ...
    public function setInteger($integer)
    {
        ...
        if (!is_null($integer) && ($integer > 100)) {
            throw new \InvalidArgumentException('invalid value for $integer when calling Body2., must be smaller than or equal to 100.');
        }
        if (!is_null($integer) && ($integer < 10)) {
            throw new \InvalidArgumentException('invalid value for $integer when calling Body2., must be bigger than or equal to 10.');
        }
    ...
    public function setInt32($int32)
    {
        ...
        if (!is_null($int32) && ($int32 > 200)) {
            throw new \InvalidArgumentException('invalid value for $int32 when calling Body2., must be smaller than or equal to 200.');
        }
        if (!is_null($int32) && ($int32 < 20)) {
            throw new \InvalidArgumentException('invalid value for $int32 when calling Body2., must be bigger than or equal to 20.');
        }
    ...
    public function setString($string)
    {
        ...
        if (!is_null($string) && (!preg_match("/[a-z]/i", $string))) {
            throw new \InvalidArgumentException("invalid value for $string when calling Body2., must conform to the pattern /[a-z]/i.");
        }
    ...
    public function setPatternWithoutDelimiter($pattern_without_delimiter)
    {
        ...
        if ((!preg_match("/^[A-Z].*/", $pattern_without_delimiter))) {
            throw new \InvalidArgumentException("invalid value for $pattern_without_delimiter when calling Body2., must conform to the pattern /^[A-Z].*/.");
        }
