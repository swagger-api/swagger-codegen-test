...
*
     * Update user
*
* @param  string $username2 name that need to be deleted (required)
* @param  int $id id (optional)
* @param  string $username username (optional)
* @param  string $first_name first_name (optional)
* @param  string $last_name last_name (optional)
...
*
     ...
     * @return void
     */
    public function updateUser($username2, $id = null, $username = null, $first_name = null, $last_name = null, $email = null, $password = null, $phone = null, $user_status = null)
    {
        $this->updateUserWithHttpInfo($username2, $id, $username, $first_name, $last_name, $email, $password, $phone, $user_status);
    }
...
*
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateUserWithHttpInfo($username2, $id = null, $username = null, $first_name = null, $last_name = null, $email = null, $password = null, $phone = null, $user_status = null)
    {
        $returnType = '';
        $request = $this->updateUserRequest($username2, $id, $username, $first_name, $last_name, $email, $password, $phone, $user_status);
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsync($username2, $id = null, $username = null, $first_name = null, $last_name = null, $email = null, $password = null, $phone = null, $user_status = null)
    {
        return $this->updateUserAsyncWithHttpInfo($username2, $id, $username, $first_name, $last_name, $email, $password, $phone, $user_status)
            ->then(
                function ($response) {
                    return $response[0];
                }
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserAsyncWithHttpInfo($username2, $id = null, $username = null, $first_name = null, $last_name = null, $email = null, $password = null, $phone = null, $user_status = null)
    {
        $returnType = '';
        $request = $this->updateUserRequest($username2, $id, $username, $first_name, $last_name, $email, $password, $phone, $user_status);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateUserRequest($username2, $id = null, $username = null, $first_name = null, $last_name = null, $email = null, $password = null, $phone = null, $user_status = null)
    {
// verify the required parameter 'username2' is set
        if ($username2 === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username2 when calling updateUser'
            );
        }
$resourcePath = '/user/{username}';
        $formParams = [];
...
if ($username2 !== null) {
            $resourcePath = str_replace(
                '{' . 'username' . '}',
                ObjectSerializer::toPathValue($username2),
                $resourcePath
            );
        }
// form params
