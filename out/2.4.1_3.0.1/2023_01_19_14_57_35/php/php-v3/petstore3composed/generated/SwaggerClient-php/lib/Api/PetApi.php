...
*
    ...
    {
        $this->addParrotWithHttpInfo($body);
    }
...
*
     ...
     * @return void
     */
    public function feedPet($body, $pet_id, $pet_type, $status, $session_id, $token)
    {
        $this->feedPetWithHttpInfo($body, $pet_id, $pet_type, $status, $session_id, $token);
    }
...
*
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function feedPetWithHttpInfo($body, $pet_id, $pet_type, $status, $session_id, $token)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $pet_id, $pet_type, $status, $session_id, $token);
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsync($body, $pet_id, $pet_type, $status, $session_id, $token)
    {
        return $this->feedPetAsyncWithHttpInfo($body, $pet_id, $pet_type, $status, $session_id, $token)
            ->then(
                function ($response) {
                    return $response[0];
                }
...
*
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function feedPetAsyncWithHttpInfo($body, $pet_id, $pet_type, $status, $session_id, $token)
    {
        $returnType = '';
        $request = $this->feedPetRequest($body, $pet_id, $pet_type, $status, $session_id, $token);
...
*
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function feedPetRequest($body, $pet_id, $pet_type, $status, $session_id, $token)
    {
// verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
