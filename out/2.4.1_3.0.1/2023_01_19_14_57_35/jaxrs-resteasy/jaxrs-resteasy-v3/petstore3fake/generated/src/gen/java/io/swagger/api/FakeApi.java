...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-01-19T15:07:20.069Z[Etc/UTC]")public class FakeApi  {
...
,@Context SecurityContext securityContext)
    ...
    public Response testEndpointParameters(@Parameter(description = "" ,required=true) Body2 body
...
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Not found") })
    public Response testEnumRequestBody(@Parameter(description = "" ) Body4 body
...
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
    public Response testJsonFormData(@Parameter(description = "" ,required=true) Body5 body
