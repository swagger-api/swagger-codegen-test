...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-01-19T15:07:20.558Z[Etc/UTC]")public class PetApi  {
...
,@Context SecurityContext securityContext)
    ...
    public Response doCategoryStuff(@Parameter(description = "" ) SubCategory body
...
,@Parameter(description = "")@FormDataParam("file")  File file
,@Context SecurityContext securityContext)
    throws NotFoundException {
