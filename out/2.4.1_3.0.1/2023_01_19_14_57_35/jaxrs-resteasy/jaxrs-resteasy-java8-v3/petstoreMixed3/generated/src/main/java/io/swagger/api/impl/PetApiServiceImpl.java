...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-01-19T15:18:05.578Z[Etc/UTC]")public class PetApiServiceImpl extends PetApiService {
    @Override
    ...
    @Override
    public Response uploadFile(Long petId, String additionalMetadata, File file, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
