...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-01-19T15:15:54.344Z[Etc/UTC]")public class StoreApi  {
   ...
   public StoreApi(@Context ServletConfig servletContext) {
    ...
    public Response deleteOrder(@Parameter(description = "ID of the order that needs to be deleted",required=true) @PathParam("orderId") Long orderId
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Order not found") })
    public Response getOrderById(@Parameter(description = "ID of order that needs to be fetched",required=true) @PathParam("orderId") Long orderId
,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response placeOrder(@Parameter(description = "")  @FormParam("id")  Long id
,@Parameter(description = "")  @FormParam("petId")  Long petId
,@Parameter(description = "")  @FormParam("quantity")  Integer quantity
,@Parameter(description = "")  @FormParam("shipDate")  OffsetDateTime shipDate
,@Parameter(description = "", schema=@Schema(allowableValues={ "placed", "approved", "delivered" })
)  @FormParam("status")  String status
,@Parameter(description = "")  @FormParam("complete")  Boolean complete
,@Context SecurityContext securityContext)
    throws NotFoundException {
