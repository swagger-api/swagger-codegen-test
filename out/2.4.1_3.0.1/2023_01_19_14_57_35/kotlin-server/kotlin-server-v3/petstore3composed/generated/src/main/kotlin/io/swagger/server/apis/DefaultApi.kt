...
import io.swagger.server.models.Test

fun Route.DefaultApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.testMethod> {  it: Paths.testMethod ->
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/test' is duplicated in code. " +
