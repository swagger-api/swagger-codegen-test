...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSCXFCDIServerCodegen", date = "2023-01-19T15:07:35.213Z[Etc/UTC]")
public class DogApi  {
...
@Parameter(description = "Dog object that needs to be added to the store" ,required=true) Object body
) {
...
@Parameter(description = "Dog object that needs to be added." ,required=true) Object body
) {
