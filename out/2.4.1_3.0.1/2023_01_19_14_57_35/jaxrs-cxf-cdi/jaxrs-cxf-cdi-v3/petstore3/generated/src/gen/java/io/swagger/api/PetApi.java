...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSCXFCDIServerCodegen", date = "2023-01-19T15:14:07.204Z[Etc/UTC]")
public class PetApi  {
...
@Parameter(description = "ID of pet to return",required=true) @PathParam("petId") Long petId
    ...
    public Response updatePet(@Multipart(value = "id", required = false)  Long id, @Multipart(value = "name", required = false)  String name, @Multipart(value = "category", required = false)  Category category, @Multipart(value = "photoUrls", required = false)  List<String> photoUrls, @Multipart(value = "tags", required = false)  List<Tag> tags, @Multipart(value = "status", required = false)  String status) {
