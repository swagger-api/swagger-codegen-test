...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSCXFCDIServerCodegen", date = "2023-01-19T15:16:58.766Z[Etc/UTC]")
public class PetApi  {
...
@Parameter(description = "status" ,required=true)@HeaderParam("token") String token
        ...
        return delegate.feedPet(body, petId, petType, status, sessionId, token, securityContext);
    }
