...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:17:17.976Z[Etc/UTC]")public interface PetApi extends ApiClient.Api {
  ...
  void feedPet(Pet body, @Param("petId") Long petId, @Param("petType") String petType, @Param("status") String status, @Param("sessionId") String sessionId, @Param("token") String token);
  ...
  void feedPet(Pet body, @Param("petId") Long petId, @Param("sessionId") String sessionId, @Param("token") String token, @QueryMap(encoded=true) Map<String, Object> queryParams);
