...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:05:29.775Z[Etc/UTC]")public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("api_key".equals(authName)) {
        ...
        auth = new OAuth(OAuthFlow.implicit, "https://petstore3.swagger.io/oauth/authorize", "", "");
      } else {
