...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:13:30.609Z[Etc/UTC]")public class UserApi {
...
if (userStatus != null)
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateUser(String username2, Long id, String username, String firstName, String lastName, String email, String password, String phone, Integer userStatus) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'username2' is set
    if (username2 == null) {
      throw new ApiException(400, "Missing the required parameter 'username2' when calling updateUser");
    }
    // create path and map variables
    String localVarPath = "/user/{username}".replaceAll("\\{format\\}","json")
