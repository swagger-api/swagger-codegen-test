...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:05:38.884Z[Etc/UTC]")public interface PetApi extends ApiClient.Api {
   ...
   *   <ul>
   *   <li>status - Status values that need to be considered for filter (optional)</li>
   *   </ul>
   * @return List&lt;Pet&gt;
