...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:05:38.884Z[Etc/UTC]")public interface UserApi extends ApiClient.Api {
  ...
  void updateUser(@Param("username2") String username2, @Param("id") Long id, @Param("username") String username, @Param("firstName") String firstName, @Param("lastName") String lastName, @Param("email") String email, @Param("password") String password, @Param("phone") String phone, @Param("userStatus") Integer userStatus);
}
