...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:13:28.707Z[Etc/UTC]")@Component("io.swagger.client.api.StoreApi")
public class StoreApi {
     ...
     * @param shipDate The shipDate parameter
     * @param status The status parameter
     * @param complete The complete parameter
     * @return Order
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
