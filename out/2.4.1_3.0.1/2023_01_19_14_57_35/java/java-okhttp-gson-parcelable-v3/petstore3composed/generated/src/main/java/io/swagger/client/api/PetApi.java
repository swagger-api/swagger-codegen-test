...
public class PetApi {
     ...
     */
    public com.squareup.okhttp.Call addParrotCall(Object body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call addParrotValidateBeforeCall(Object body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public Object addParrot(Object body) throws ApiException {
        ApiResponse<Object> resp = addParrotWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> addParrotWithHttpInfo(Object body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call addParrotAsync(Object body, final ApiCallback<Object> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call feedPetCall(Pet body, Long petId, String petType, String status, String sessionId, String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call feedPetValidateBeforeCall(Pet body, Long petId, String petType, String status, String sessionId, String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = feedPetCall(body, petId, petType, status, sessionId, token, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> feedPetWithHttpInfo(Pet body, Long petId, String petType, String status, String sessionId, String token) throws ApiException {
        com.squareup.okhttp.Call call = feedPetValidateBeforeCall(body, petId, petType, status, sessionId, token, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call feedPetAsync(Pet body, Long petId, String petType, String status, String sessionId, String token, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = feedPetValidateBeforeCall(body, petId, petType, status, sessionId, token, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
