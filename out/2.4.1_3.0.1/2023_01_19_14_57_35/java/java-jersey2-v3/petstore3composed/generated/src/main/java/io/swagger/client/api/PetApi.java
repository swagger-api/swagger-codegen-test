...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:16:54.226Z[Etc/UTC]")public class PetApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public void feedPet(Pet body, Long petId, String petType, String status, String sessionId, String token) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
