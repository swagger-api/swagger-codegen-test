...
<a name="updateUser"></a>
# **updateUser**
> updateUser(username2, id, username, firstName, lastName, email, password, phone, userStatus)
...
Integer userStatus = 56; // Integer | 
try {
    apiInstance.updateUser(username2, id, username, firstName, lastName, email, password, phone, userStatus);
} catch (ApiException e) {
