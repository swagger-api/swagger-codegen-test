...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-01-19T15:07:20.258Z[Etc/UTC]")@XmlRootElement(name = "NullableEnumModel")
@XmlAccessorType(XmlAccessType.FIELD)
@JacksonXmlRootElement(localName = "NullableEnumModel")public class NullableEnumModel {
  /**
