...
public interface PetApi {
  ...
  @POST("/pet/feed/{petId}")
  Void feedPet(
    @retrofit.http.Body Pet body, @retrofit.http.Path("petId") Long petId, @retrofit.http.Query("petType") String petType, @retrofit.http.Query("status") String status, , @retrofit.http.Header("token") String token
  );
  ...
  @POST("/pet/feed/{petId}")
  void feedPet(
    @retrofit.http.Body Pet body, @retrofit.http.Path("petId") Long petId, @retrofit.http.Query("petType") String petType, @retrofit.http.Query("status") String status, , @retrofit.http.Header("token") String token, Callback<Void> cb
  );
  /**
