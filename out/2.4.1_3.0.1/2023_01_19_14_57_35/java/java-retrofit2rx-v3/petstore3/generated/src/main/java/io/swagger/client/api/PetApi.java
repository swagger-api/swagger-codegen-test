...
public interface PetApi {
  ...
  Call<List<Pet>> findPetsByStatus(
        @retrofit2.http.Path("status") String status                
  );
  ...
  Call<Void> updatePetWithForm(
            @retrofit2.http.Path("petId") Long petId            ,     @retrofit2.http.Path("name") String name                ,     @retrofit2.http.Path("status") String status                
  );
  ...
  Call<ModelApiResponse> uploadFile(
            @retrofit2.http.Path("petId") Long petId            ,                 @retrofit2.http.Body Object body    ,     @retrofit2.http.Path("additionalMetadata") String additionalMetadata                
  );
