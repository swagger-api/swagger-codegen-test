...
public interface PetApi {
  ...
  @POST("pet/feed/{petId}")
  Call<Void> feedPet(
                    @retrofit2.http.Body Pet body    ,         @retrofit2.http.Path("petId") Long petId            ,     @retrofit2.http.Path("petType") String petType                ,     @retrofit2.http.Path("status") String status                ,                     ,             @retrofit2.http.Header("token") String token        
  );
