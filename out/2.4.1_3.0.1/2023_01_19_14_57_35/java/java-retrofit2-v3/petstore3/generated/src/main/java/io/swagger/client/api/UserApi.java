...
public interface UserApi {
  ...
  Call<Void> updateUser(
            @retrofit2.http.Path("username") String username2            ,                     @retrofit2.http.Field("id") Long id,                     @retrofit2.http.Field("username") String username,                     @retrofit2.http.Field("firstName") String firstName,                     @retrofit2.http.Field("lastName") String lastName,                     @retrofit2.http.Field("email") String email,                     @retrofit2.http.Field("password") String password,                     @retrofit2.http.Field("phone") String phone,                     @retrofit2.http.Field("userStatus") Integer userStatus
  );
