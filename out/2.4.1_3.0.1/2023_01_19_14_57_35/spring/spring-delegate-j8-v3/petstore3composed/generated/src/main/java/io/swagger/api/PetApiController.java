...
public class PetApiController implements PetApi {
    ...
    public ResponseEntity<Void> feedPet(@ApiParam(value = "Pet object that needs to be added to the store" ,required=true )  @Valid @RequestBody Pet body,@ApiParam(value = "ID of pet to return",required=true) @PathVariable("petId") Long petId,@NotNull @ApiParam(value = "type of food", required = true) @Valid @RequestParam(value = "petType", required = true) String petType,@NotNull @ApiParam(value = "status", required = true) @Valid @RequestParam(value = "status", required = true) String status,,@ApiParam(value = "status" ,required=true) @RequestHeader(value="token", required=true) String token) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
