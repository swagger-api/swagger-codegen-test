...
public interface StoreApi {
    ...
    @ApiOperation(value = "Returns pet inventories by status", nickname = "getInventory", notes = "Returns a map of status codes to quantities", response = Map.class, responseContainer = "Map", authorizations = {
    ...
    ResponseEntity<Order> placeOrder(@ApiParam(value = "") @RequestParam(value="id", required=false)  Long id,@ApiParam(value = "") @RequestParam(value="petId", required=false)  Long petId,@ApiParam(value = "") @RequestParam(value="quantity", required=false)  Integer quantity,@ApiParam(value = "") @RequestParam(value="shipDate", required=false)  OffsetDateTime shipDate,@ApiParam(value = "", allowableValues="placed, approved, delivered") @RequestParam(value="status", required=false)  String status,@ApiParam(value = "") @RequestParam(value="complete", required=false)  Boolean complete);
