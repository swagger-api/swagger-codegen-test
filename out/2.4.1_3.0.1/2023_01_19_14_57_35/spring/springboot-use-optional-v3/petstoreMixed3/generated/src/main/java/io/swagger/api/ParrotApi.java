...
public interface ParrotApi {
    ...
    @ApiOperation(value = "Add a new parrow to the store", nickname = "addParrot", notes = "", response = Object.class, authorizations = {
    ...
    ResponseEntity<InlineResponse200> updateParrots(@ApiParam(value = ""  )  @Valid @RequestBody Body8 body);
