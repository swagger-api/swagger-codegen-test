...
public class UserApiController implements UserApi {
    ...
    public ResponseEntity<String> loginUser(@ApiParam(value = "The user name for login") @Valid @RequestParam(value = "username", required = false) Optional<String> username,@ApiParam(value = "The password for login in clear text") @Valid @RequestParam(value = "password", required = false) Optional<String> password) {
        String accept = request.getHeader("Accept");
