...
public class PetApiController implements PetApi {
    ...
    public ResponseEntity<List<Pet>> findPetsByStatus(@ApiParam(value = "Status values that need to be considered for filter", allowableValues = "available, pending, sold") @Valid @RequestParam(value = "status", required = false) Optional<String> status) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<List<Pet>>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<List<Pet>> findPetsByTags(@ApiParam(value = "Tags to filter by") @Valid @RequestParam(value = "tags", required = false) Optional<List<String>> tags) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<List<Pet>>(HttpStatus.NOT_IMPLEMENTED);
    }
    ...
    public ResponseEntity<ModelApiResponse> uploadFile(@ApiParam(value = "ID of pet to update",required=true) @PathVariable("petId") Long petId,@ApiParam(value = ""  )  @Valid @RequestBody Object body,@ApiParam(value = "Additional Metadata") @Valid @RequestParam(value = "additionalMetadata", required = false) Optional<String> additionalMetadata) {
        String accept = request.getHeader("Accept");
