...
public class PetApiControllerIntegrationTest {
    ...
    public void doCategoryStuffTest() throws Exception {
        ...
        ResponseEntity<ModelApiResponse> responseEntity = api.doCategoryStuff(body);
        assertEquals(HttpStatus.NOT_IMPLEMENTED, responseEntity.getStatusCode());
    }
    ...
    public void feedPetTest() throws Exception {
        Pet body = new Pet();
        Long petId = 789L;
        String petType = "petType_example";
        String status = "status_example";
        String sessionId = "sessionId_example";
        String token = "token_example";
        ResponseEntity<Void> responseEntity = api.feedPet(body, petId, petType, status, sessionId, token);
        assertEquals(HttpStatus.NOT_IMPLEMENTED, responseEntity.getStatusCode());
    }
    ...
    public void uploadFileTest() throws Exception {
        Long petId = 789L;
        Object body = null;
        ResponseEntity<ModelApiResponse> responseEntity = api.uploadFile(petId, body);
        assertEquals(HttpStatus.NOT_IMPLEMENTED, responseEntity.getStatusCode());
    }
