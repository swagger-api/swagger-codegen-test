...
public class FakeApiControllerIT {
    ...
    public void testEnumParametersTest() throws Exception {
        final String requestURL = "http://localhost:8002/v3/fake?enumQueryStringArray=enumQueryStringArray_example&enumQueryString=enumQueryString_example&enumQueryInteger=56";
