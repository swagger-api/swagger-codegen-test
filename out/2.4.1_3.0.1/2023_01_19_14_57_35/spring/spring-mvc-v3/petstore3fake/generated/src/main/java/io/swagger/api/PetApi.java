...
public interface PetApi {
    ...
    @RequestMapping(value = "/pet/{petId}/uploadImage",
        ...
        method = RequestMethod.POST)
    ResponseEntity<ModelApiResponse> uploadFile(@ApiParam(value = "ID of pet to update",required=true) @PathVariable("petId") Long petId,@ApiParam(value = "") @RequestParam(value="additionalMetadata", required=false)  String additionalMetadata,@ApiParam(value = "") @RequestParam(value="file", required=false)  File file);
