...
class StoreApi(
   ...
   * @return Future(Map)
   */
  def getInventoryAsync(): Future[Map] = {
      helper.getInventory()
  }
   ...
   * @return Order
   */
  def placeOrder(id: Option[Long] = None, petId: Option[Long] = None, quantity: Option[Integer] = None, shipDate: Option[Date] = None, status: Option[String] = None, complete: Option[Boolean] = None): Option[Order] = {
    val await = Try(Await.result(placeOrderAsync(id, petId, quantity, shipDate, status, complete), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(Order)
   */
  def placeOrderAsync(id: Option[Long] = None, petId: Option[Long] = None, quantity: Option[Integer] = None, shipDate: Option[Date] = None, status: Option[String] = None, complete: Option[Boolean] = None): Future[Order] = {
      helper.placeOrder(id, petId, quantity, shipDate, status, complete)
  }
...
class StoreApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getInventory()(implicit reader: ClientResponseReader[Map]): Future[Map] = {
    // create path and map variables
  ...
  def placeOrder(id: Option[Long] = None,
