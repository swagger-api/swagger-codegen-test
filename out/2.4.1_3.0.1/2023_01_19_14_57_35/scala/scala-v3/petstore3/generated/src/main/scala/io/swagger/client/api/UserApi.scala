...
class UserApi(
   ...
   * @return User
   */
  def createUser(id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None): Option[User] = {
    val await = Try(Await.result(createUserAsync(id, username, firstName, lastName, email, password, phone, userStatus), Duration.Inf))
    await match {
   ...
   * @return Future(User)
   */
  def createUserAsync(id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None): Future[User] = {
      helper.createUser(id, username, firstName, lastName, email, password, phone, userStatus)
  }
   ...
   * @return User
   */
  def createUsersWithListInput(body: Option[List[User]] = None): Option[User] = {
   ...
   * @return Future(User)
   */
  def createUsersWithListInputAsync(body: Option[List[User]] = None): Future[User] = {
   ...
   * @return String
   */
  def loginUser(username: Option[String] = None, password: Option[String] = None): Option[String] = {
   ...
   */
  def loginUserAsync(username: Option[String] = None, password: Option[String] = None): Future[String] = {
   ...
   * @return void
   */
  def updateUser(username2: String, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None) = {
    val await = Try(Await.result(updateUserAsync(username2, id, username, firstName, lastName, email, password, phone, userStatus), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(void)
   */
  def updateUserAsync(username2: String, id: Option[Long] = None, username: Option[String] = None, firstName: Option[String] = None, lastName: Option[String] = None, email: Option[String] = None, password: Option[String] = None, phone: Option[String] = None, userStatus: Option[Integer] = None) = {
      helper.updateUser(username2, id, username, firstName, lastName, email, password, phone, userStatus)
  }
...
class UserApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def createUser(id: Option[Long] = None,
  ...
  def createUsersWithListInput(body: Option[List[User]] = None
    )(implicit reader: ClientResponseReader[User], writer: RequestWriter[Option[List[User]]]): Future[User] = {
    // create path and map variables
  ...
  def updateUser(username2: String,
    id: Option[Long] = None,
    username: Option[String] = None,
    firstName: Option[String] = None,
    lastName: Option[String] = None,
    ...
    // create path and map variables
    val path = (addFmt("/user/{username}")
      replaceAll("\\{" + "username" + "\\}", username2.toString))

    // query params
    val queryParams = new mutable.HashMap[String, String]
    val headerParams = new mutable.HashMap[String, String]

    if (username2 == null) throw new Exception("Missing required parameter 'username2' when calling UserApi->updateUser")
