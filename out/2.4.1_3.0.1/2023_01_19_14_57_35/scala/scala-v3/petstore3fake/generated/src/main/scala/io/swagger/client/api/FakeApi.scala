...
class FakeApi(
   ...
   * @return void
   */
  def testEndpointParameters(body: Body2) = {
   ...
   * @return Future(void)
   */
  def testEndpointParametersAsync(body: Body2) = {
   ...
   * @return void
   */
  def testEnumParameters(enumHeaderStringArray: Option[List[String]] = None, enumHeaderString: Option[String] = None, enumQueryStringArray: Option[List[String]] = None, enumQueryString: Option[String] = None, enumQueryInteger: Option[Integer] = None) = {
   ...
   * @return Future(void)
   */
  def testEnumParametersAsync(enumHeaderStringArray: Option[List[String]] = None, enumHeaderString: Option[String] = None, enumQueryStringArray: Option[List[String]] = None, enumQueryString: Option[String] = None, enumQueryInteger: Option[Integer] = None) = {
   ...
   * @return void
   */
  def testEnumRequestBody(body: Option[Body4] = None) = {
   ...
   * @return Future(void)
   */
  def testEnumRequestBodyAsync(body: Option[Body4] = None) = {
   ...
   * @return void
   */
  def testInlineAdditionalProperties(body: Map) = {
   ...
   * @return Future(void)
   */
  def testInlineAdditionalPropertiesAsync(body: Map) = {
   ...
   * @return void
   */
  def testJsonFormData(body: Body5) = {
   ...
   * @return Future(void)
   */
  def testJsonFormDataAsync(body: Body5) = {
...
class FakeApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def testEndpointParameters(body: Body2)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[Body2]): Future[Unit] = {
    // create path and map variables
    val path = (addFmt("/fake"))
  ...
  def testEnumParameters(enumHeaderStringArray: Option[List[String]] = None,
    enumHeaderString: Option[String] = None,
    enumQueryStringArray: Option[List[String]] = None,
    enumQueryString: Option[String] = None,
  ...
  def testEnumRequestBody(body: Option[Body4] = None
    )(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[Option[Body4]]): Future[Unit] = {
    // create path and map variables
  ...
  def testInlineAdditionalProperties(body: Map)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[Map]): Future[Unit] = {
    // create path and map variables
  ...
  def testJsonFormData(body: Body5)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[Body5]): Future[Unit] = {
    // create path and map variables
