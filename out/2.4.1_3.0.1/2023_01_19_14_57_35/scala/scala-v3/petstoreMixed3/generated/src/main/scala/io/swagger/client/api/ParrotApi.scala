...
class ParrotApi(
   ...
   */
  def updateParrots(body: Option[Body8] = None): Option[inline_response_200] = {
   ...
   */
  def updateParrotsAsync(body: Option[Body8] = None): Future[inline_response_200] = {
...
class ParrotApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def updateParrots(body: Option[Body8] = None
    )(implicit reader: ClientResponseReader[inline_response_200], writer: RequestWriter[Option[Body8]]): Future[inline_response_200] = {
    // create path and map variables
    val path = (addFmt("/parrot"))
