...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaPlayFrameworkCodegen", date = "2023-01-19T14:59:59.324Z")
...
public class StoreApiController extends Controller {
    ...
    @ApiAction
    public CompletionStage<Result> deleteOrder( @Min(1)Long orderId) throws Exception {
    ...
    @ApiAction
    public CompletionStage<Result> getOrderById( @Min(1) @Max(10)Long orderId) throws Exception {
