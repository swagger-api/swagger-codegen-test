...
,  @HeaderParam("api_key") 
 ...
 String apiKey
    ...
    Response getDogById( @PathParam("dogId")
 ...
 @Parameter(description = "ID of dog to return") Long dogId
    ...
    Response updateDog(@Valid Object body);
    @POST
    @Path("/{dogId}")
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    Response updateDogWithForm( @PathParam("dogId")
