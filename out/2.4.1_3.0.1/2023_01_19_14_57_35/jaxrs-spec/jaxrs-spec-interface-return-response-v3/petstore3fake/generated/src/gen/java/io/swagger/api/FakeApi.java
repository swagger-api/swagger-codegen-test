...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-01-19T15:07:24.467Z[Etc/UTC]")
public interface FakeApi {
    ...
    Response testEndpointParameters(@Valid Body2 body);
    @GET
...
,  @QueryParam("enum_query_integer") 
 ...
 @Parameter(description = "Query parameter enum test (double)")  Integer enumQueryInteger
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "400", description = "Invalid request"),
        @ApiResponse(responseCode = "404", description = "Not found") })
    Response testEnumRequestBody(@Valid Body4 body);
    @POST
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
    Response testJsonFormData(@Valid Body5 body);}
