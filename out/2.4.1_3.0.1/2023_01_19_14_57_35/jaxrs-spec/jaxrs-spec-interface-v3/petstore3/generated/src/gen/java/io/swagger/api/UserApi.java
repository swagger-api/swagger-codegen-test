...
public interface UserApi {
    ...
    User createUsersWithListInput(@Valid List<User> body);
    @DELETE
    @Path("/{username}")
 ...
 @Parameter(description = "The name that needs to be fetched. Use user1 for testing. ") String username
    ...
    String loginUser(  @QueryParam("username") 
...
,  @QueryParam("password") 
 ...
 @Parameter(description = "The password for login in clear text")  String password
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
    void updateUser( @PathParam("username")

 @Parameter(description = "name that need to be deleted") String username2
,@FormParam(value = "id")  Long id,@FormParam(value = "username")  String username,@FormParam(value = "firstName")  String firstName,@FormParam(value = "lastName")  String lastName,@FormParam(value = "email")  String email,@FormParam(value = "password")  String password,@FormParam(value = "phone")  String phone,@FormParam(value = "userStatus")  Integer userStatus);}
