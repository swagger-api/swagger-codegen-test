...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2023-01-19T15:11:56.108Z")
public class FakeApi {
    ...
    public Response testBodyWithQueryParams(@Valid User body,@QueryParam("query") @NotNull    String query) {
        return Response.ok().entity("magic!").build();
    }
