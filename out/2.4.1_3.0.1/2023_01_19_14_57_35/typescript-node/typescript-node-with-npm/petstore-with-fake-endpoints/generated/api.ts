...
export class AnotherFakeApi {
     ...
     */
    public testSpecialTags (body: Client) : Promise<{ response: http.ClientResponse; body: Client;  }> {
...
export class FakeApi {
     ...
     */
    public fakeOuterBooleanSerialize (body?: OuterBoolean) : Promise<{ response: http.ClientResponse; body: OuterBoolean;  }> {
     ...
     */
    public fakeOuterCompositeSerialize (body?: OuterComposite) : Promise<{ response: http.ClientResponse; body: OuterComposite;  }> {
     ...
     */
    public fakeOuterNumberSerialize (body?: OuterNumber) : Promise<{ response: http.ClientResponse; body: OuterNumber;  }> {
     ...
     */
    public fakeOuterStringSerialize (body?: OuterString) : Promise<{ response: http.ClientResponse; body: OuterString;  }> {
     ...
     * @param query 
     */
    public testBodyWithQueryParams (body: User, query: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
     ...
     * @param body client model
     */
    public testClientModel (body: Client) : Promise<{ response: http.ClientResponse; body: Client;  }> {
     ...
     * @param callback None
     */
    public testEndpointParameters (number: number, _double: number, patternWithoutDelimiter: string, _byte: string, integer?: number, int32?: number, int64?: number, _float?: number, string?: string, binary?: string, date?: string, dateTime?: Date, password?: string, callback?: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/fake';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     */
    public testEnumParameters (enumFormStringArray?: Array<'>' | '$'>, enumFormString?: '_abc' | '-efg' | '(xyz)', enumHeaderStringArray?: Array<'>' | '$'>, enumHeaderString?: '_abc' | '-efg' | '(xyz)', enumQueryStringArray?: Array<'>' | '$'>, enumQueryString?: '_abc' | '-efg' | '(xyz)', enumQueryInteger?: 1 | -2, enumQueryDouble?: 1.1 | -1.2) : Promise<{ response: http.ClientResponse; body?: any;  }> {
        const localVarPath = this.basePath + '/fake';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     */
    public testInlineAdditionalProperties (param: any) : Promise<{ response: http.ClientResponse; body?: any;  }> {
     ...
     * @param param2 field2
     */
    public testJsonFormData (param: string, param2: string) : Promise<{ response: http.ClientResponse; body?: any;  }> {
...
export class FakeClassnameTags123Api {
     ...
     * @param body client model
     */
    public testClassname (body: Client) : Promise<{ response: http.ClientResponse; body: Client;  }> {
