...
public interface PetApi  {
    ...
    public void feedPet(Pet body, @PathParam("petId") Long petId, @QueryParam("petType")String petType, @QueryParam("status")String status, , @HeaderParam("token") String token);
