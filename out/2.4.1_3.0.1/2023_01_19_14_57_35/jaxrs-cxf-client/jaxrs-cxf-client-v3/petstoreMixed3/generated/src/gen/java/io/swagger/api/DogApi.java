...
public interface DogApi  {
    ...
    @Operation(summary = "Add a new dog to the store", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    public void addDog(Object body);
    ...
    @DELETE
    @Path("/dog/{dogId}")
    @Operation(summary = "Deletes a dog", tags={  })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Find dog by ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/dog")
    @Consumes({ "application/json", "application/xml" })
    @Operation(summary = "Update an existing dog", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "400", description = "Invalid ID supplied"),
        @ApiResponse(responseCode = "404", description = "Animal not found"),
        @ApiResponse(responseCode = "405", description = "Validation exception") })
    public void updateDog(Object body);
    ...
    @Operation(summary = "Updates a dog", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "405", description = "Invalid input") })
