...
public interface FakeApi  {
    ...
    @Operation(summary = "To test \"client\" model", tags={  })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Fake endpoint for testing various parameters 假端點 偽のエンドポイント 가짜 엔드 포인트 ", tags={  })
    @ApiResponses(value = { 
    ...
    @GET
    @Path("/fake")
    @Operation(summary = "To test enum parameters", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Operation(summary = "test inline additionalProperties", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Operation(summary = "test json serialization of form data", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
