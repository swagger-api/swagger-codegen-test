...
public interface AnimalApi  {
    ...
    @Operation(summary = "Add a new animal to the store", tags={  })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Deletes a animal", tags={  })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Find animal by ID", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/animal")
    @Consumes({ "application/json", "application/xml" })
    @Operation(summary = "Update an existing animal", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "400", description = "Invalid ID supplied"),
    ...
    @Operation(summary = "Updates a animal", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "405", description = "Invalid input") })
