...
public interface PetApi  {
    ...
    public void feedPet(@Valid Pet body, @PathParam("petId") Long petId, @QueryParam("petType") @NotNull String petType, @QueryParam("status") @NotNull String status, , @HeaderParam("token") String token);
