...
public interface PetApi  {
    ...
    public Pet addPet(@Multipart(value = "id", required = false)  Long id, @Multipart(value = "name", required = false)  String name, @Multipart(value = "category", required = false)  Category category, @Multipart(value = "photoUrls", required = false)  List<String> photoUrls, @Multipart(value = "tags", required = false)  List<Tag> tags, @Multipart(value = "status", required = false)  String status);
    ...
    public List<Pet> findPetsByStatus(@QueryParam("status") String status);
    ...
    public Pet updatePet(@Multipart(value = "id", required = false)  Long id, @Multipart(value = "name", required = false)  String name, @Multipart(value = "category", required = false)  Category category, @Multipart(value = "photoUrls", required = false)  List<String> photoUrls, @Multipart(value = "tags", required = false)  List<Tag> tags, @Multipart(value = "status", required = false)  String status);
    ...
    public ModelApiResponse uploadFile(@PathParam("petId") Long petId, @Valid Object body, @QueryParam("additionalMetadata") String additionalMetadata);
}
