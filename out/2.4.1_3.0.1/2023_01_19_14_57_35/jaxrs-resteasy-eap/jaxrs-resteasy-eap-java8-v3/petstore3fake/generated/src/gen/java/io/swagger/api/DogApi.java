...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2023-01-19T15:07:26.822Z[Etc/UTC]")public interface DogApi  {
    ...
    Response addDog(@Parameter(description = "Dog object that needs to be added to the store" ,required=true) Object body,@Context SecurityContext securityContext);
    ...
    Response updateDog(@Parameter(description = "Dog object that needs to be added." ,required=true) Object body,@Context SecurityContext securityContext);
