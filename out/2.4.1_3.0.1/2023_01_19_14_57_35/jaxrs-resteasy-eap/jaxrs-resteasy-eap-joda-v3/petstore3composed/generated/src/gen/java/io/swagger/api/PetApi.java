...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2023-01-19T15:17:02.123Z[Etc/UTC]")public interface PetApi  {
    ...
    Response feedPet(@Parameter(description = "Pet object that needs to be added to the store" ,required=true) Pet body, @PathParam("petId") Long petId, @NotNull @QueryParam("petType") String petType, @NotNull @QueryParam("status") String status,,@Parameter(description = "status" ,required=true)@HeaderParam("token") String token,@Context SecurityContext securityContext);
