...
export interface PetServiceInterface {
    ...
    * @param body 
    */
    doCategoryStuff(body?: SubCategory, extraHttpRequestParams?: any): Observable<ApiResponse>;
    ...
    * 
    */
    getAllPets(extraHttpRequestParams?: any): Observable<AllPetsResponse>;
    ...
    * 
    */
    getRandomPet(extraHttpRequestParams?: any): Observable<SinglePetResponse>;
    ...
    * @param file 
    */
    uploadFile(petId: number, additionalMetadata?: string, file?: string, extraHttpRequestParams?: any): Observable<ApiResponse>;
