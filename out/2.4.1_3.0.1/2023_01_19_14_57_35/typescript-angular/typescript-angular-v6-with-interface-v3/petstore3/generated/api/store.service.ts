...
export class StoreService implements StoreServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public placeOrder(id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'body', reportProgress?: boolean): Observable<Order>;
    public placeOrder(id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Order>>;
    public placeOrder(id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Order>>;
    public placeOrder(id?: number, petId?: number, quantity?: number, shipDate?: Date, status?: string, complete?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (petId !== undefined) {
            formParams = formParams.append('petId', <any>petId) || formParams;
        }
        if (quantity !== undefined) {
            formParams = formParams.append('quantity', <any>quantity) || formParams;
        }
        if (shipDate !== undefined) {
            formParams = formParams.append('shipDate', <any>shipDate) || formParams;
        }
        if (status !== undefined) {
            formParams = formParams.append('status', <any>status) || formParams;
        }
        if (complete !== undefined) {
            formParams = formParams.append('complete', <any>complete) || formParams;
        }
