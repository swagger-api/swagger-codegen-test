...
import { AnimalServiceInterface }                            from './animal.serviceInterface';


@Injectable()
export class AnimalService implements AnimalServiceInterface {
    ...
    public addAnimal(body: Animal, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (this.configuration.apiKeys["api_key_query"]) {
        ...
        return this.httpClient.post(`${this.basePath}/animal`,
            {
    ...
    public deleteAnimal(animalId: number, apiKey?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete(`${this.basePath}/animal/${encodeURIComponent(String(animalId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getAnimalById(animalId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get(`${this.basePath}/animal/${encodeURIComponent(String(animalId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateAnimal(body: Animal, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put(`${this.basePath}/animal`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateAnimalWithForm(animalId: number, name?: string, status?: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateAnimalWithForm(animalId: number, name?: string, status?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateAnimalWithForm(animalId: number, name?: string, status?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateAnimalWithForm(animalId: number, name?: string, status?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (animalId === null || animalId === undefined) {
        ...
        return this.httpClient.post(`${this.basePath}/animal/${encodeURIComponent(String(animalId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
