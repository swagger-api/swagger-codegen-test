...
export * from './animal.serviceInterface'
...
export * from './dog.serviceInterface'
...
export * from './master.serviceInterface'
export * from './parrot.service';
import { ParrotService } from './parrot.service';
export * from './parrot.serviceInterface'
...
export const APIS = [AnimalService, AnotherFakeService, DogService, FakeService, FakeClassnameTags123Service, MasterService, ParrotService, PetService, StoreService, UserService];
