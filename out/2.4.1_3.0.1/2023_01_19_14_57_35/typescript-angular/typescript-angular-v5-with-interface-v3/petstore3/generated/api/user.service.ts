...
export class UserService implements UserServiceInterface {
     ...
     */
    public createUser(id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'body', reportProgress?: boolean): Observable<User>;
    public createUser(id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<User>>;
    public createUser(id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<User>>;
    public createUser(id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (phone !== undefined) {
            formParams = formParams.append('phone', <any>phone) || formParams;
        }
        if (userStatus !== undefined) {
            formParams = formParams.append('userStatus', <any>userStatus) || formParams;
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUser(username2: string, id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUser(username2: string, id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUser(username2: string, id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUser(username2: string, id?: number, username?: string, firstName?: string, lastName?: string, email?: string, password?: string, phone?: string, userStatus?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (username2 === null || username2 === undefined) {
            throw new Error('Required parameter username2 was null or undefined when calling updateUser.');
        }
