...
export class PetService {
    ...
    public doCategoryStuff(body?: SubCategory, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/pet/category`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public feedPet(body: Pet, petId: number, petType: string, status: string, sessionId: string, token: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public feedPet(body: Pet, petId: number, petType: string, status: string, sessionId: string, token: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public feedPet(body: Pet, petId: number, petType: string, status: string, sessionId: string, token: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public feedPet(body: Pet, petId: number, petType: string, status: string, sessionId: string, token: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(`${this.basePath}/pet/feed/${encodeURIComponent(String(petId))}`,
            {
