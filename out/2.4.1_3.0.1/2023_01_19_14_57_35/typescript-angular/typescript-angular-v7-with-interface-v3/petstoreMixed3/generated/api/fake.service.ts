...
export class FakeService implements FakeServiceInterface {
    ...
    public fakeOuterBooleanSerialize(body?: boolean, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/fake/outer/boolean`,
            {
    ...
    public fakeOuterCompositeSerialize(body?: OuterComposite, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/fake/outer/composite`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fakeOuterNumberSerialize(body?: BigDecimal, observe?: 'body', reportProgress?: boolean): Observable<OuterNumber>;
    public fakeOuterNumberSerialize(body?: BigDecimal, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OuterNumber>>;
    public fakeOuterNumberSerialize(body?: BigDecimal, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OuterNumber>>;
    public fakeOuterNumberSerialize(body?: BigDecimal, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/fake/outer/number`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public fakeOuterStringSerialize(body?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/fake/outer/string`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public testClientModel(body: Client, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.patch(`${this.basePath}/fake`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testEndpointParameters(body: Body2, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public testEndpointParameters(body: Body2, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public testEndpointParameters(body: Body2, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public testEndpointParameters(body: Body2, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(`${this.basePath}/fake`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public testEnumParameters(enumHeaderStringArray?: Array<string>, enumHeaderString?: string, enumQueryStringArray?: Array<string>, enumQueryString?: string, enumQueryInteger?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (enumQueryStringArray) {
            enumQueryStringArray.forEach((element) => {
                queryParameters = queryParameters.append('enum_query_string_array', <any>element);
            })
        }
        ...
        return this.httpClient.get(`${this.basePath}/fake`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testEnumRequestBody(body?: Body4, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public testEnumRequestBody(body?: Body4, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public testEnumRequestBody(body?: Body4, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public testEnumRequestBody(body?: Body4, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post(`${this.basePath}/fake/enum/form`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testInlineAdditionalProperties(body: any, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public testInlineAdditionalProperties(body: any, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public testInlineAdditionalProperties(body: any, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public testInlineAdditionalProperties(body: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(`${this.basePath}/fake/inline-additionalProperties`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public testJsonFormData(body: Body5, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public testJsonFormData(body: Body5, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public testJsonFormData(body: Body5, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public testJsonFormData(body: Body5, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
        ...
        return this.httpClient.post(`${this.basePath}/fake/jsonFormData`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
