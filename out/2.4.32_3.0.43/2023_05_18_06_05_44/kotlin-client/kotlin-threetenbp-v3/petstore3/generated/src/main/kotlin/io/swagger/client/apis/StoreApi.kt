...
class StoreApi(basePath: kotlin.String = "https://raw.githubusercontent.com/api/v3") : ApiClient(basePath) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun placeOrder(id: kotlin.Long? = null, petId: kotlin.Long? = null, quantity: kotlin.Int? = null, shipDate: org.threeten.bp.LocalDateTime? = null, status: kotlin.String? = null, complete: kotlin.Boolean? = null): Order {
