...
class PetApi(basePath: kotlin.String = "/") : ApiClient(basePath) {
     ...
     * @return void
     */
    fun feedPet(body: Pet, token: kotlin.String, petType: kotlin.String, status: kotlin.String, petId: kotlin.Long, sessionId: kotlin.String): Unit {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            put("petType", listOf(petType.toString()))
            put("status", listOf(status.toString()))
        }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        token.apply {
            localVariableHeaders["token"] = this.toString()
        }
