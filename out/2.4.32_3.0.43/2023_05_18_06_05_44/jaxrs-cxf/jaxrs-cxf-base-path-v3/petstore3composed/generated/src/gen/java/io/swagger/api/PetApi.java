 ...
 *
 */
@Path("/swagger-api/swagger-codegen/d7d5b9a97447f40e130e132cdf0cf7ee7c626cb8/fixtures/immutable/specifications/v3/petstore3composed.yaml")
public interface PetApi  {
    ...
    public void feedPet(@Valid Pet body, @HeaderParam("token") String token, @QueryParam("petType") @NotNull String petType, @QueryParam("status") @NotNull String status, @PathParam("petId") Long petId, @CookieParam("sessionId") String sessionId);
