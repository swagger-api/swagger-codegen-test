...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2023-05-18T06:16:14.780Z[Etc/UTC]")
...
"read:pets"        })    }, tags={ "pet" })
    ...
    Response uploadFile(MultipartFormDataInput input, @PathParam("petId") Long petId,@Parameter(description = "")@FormParam("additionalMetadata")  String additionalMetadata,@Context SecurityContext securityContext);
