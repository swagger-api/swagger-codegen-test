...
class EnumTest(Model):
    ...
    def __init__(self, enum_string: str=None, enum_string_required: str=None, enum_integer: int=None, enum_number: float=None, outer_enum: OuterEnum=None):  # noqa: E501
    ...
    def enum_string_required(self, enum_string_required: str):
