...
public interface PetApi  {
    ...
    public void feedPet(Pet body, @HeaderParam("token") String token, @QueryParam("petType")String petType, @QueryParam("status")String status, @PathParam("petId") Long petId, @CookieParam("sessionId") String sessionId);
