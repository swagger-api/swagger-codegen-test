...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2023-05-18T06:10:34.167Z[Etc/UTC]")
public class PetApi  {
...
@Parameter(description = "Pet object that needs to be added to the store" ,required=true) Pet body
,@Parameter(description = "status" ,required=true)@HeaderParam("token") String token, @NotNull  @QueryParam("petType") String petType, @NotNull  @QueryParam("status") String status, @PathParam("petId") Long petId,
@Parameter(description = "session id" ,required=true) String sessionId
,@Context SecurityContext securityContext)
    throws NotFoundException {
