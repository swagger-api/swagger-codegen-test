...
public interface StoreApiService {
      ...
      Response placeOrder(Long id,Long petId,Integer quantity,OffsetDateTime shipDate,String status,Boolean complete,SecurityContext securityContext) throws NotFoundException;
}
