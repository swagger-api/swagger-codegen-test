...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2023-05-18T06:07:21.487Z")
public class StoreApiImpl implements StoreApi {
    ...
    public void deleteOrder(Long orderId, Handler<AsyncResult<Void>> resultHandler) {
        ...
        String localVarPath = "/store/order/{orderId}".replaceAll("\\{" + "orderId" + "\\}", orderId.toString());
