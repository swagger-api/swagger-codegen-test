...
--
--  NOTE: This package is auto generated by the swagger code generator 2.4.30.
...
package body Samples.Petstore.Clients is
   ...
   procedure Test_Special_Tags
      (Client : in out Client_Type;
       ...
       Result : out Samples.Petstore.Models.Client_Type) is
   ...
   procedure Fake_Outer_Boolean_Serialize
      (Client : in out Client_Type;
       ...
       Result : out Samples.Petstore.Models.OuterBoolean_Type) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
      Reply : Swagger.Value_Type;
   begin
      ...
      URI.Set_Path ("/fake/outer/boolean");
      Client.Call (Swagger.Clients.POST, URI, Req, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Fake_Outer_Boolean_Serialize;
   ...
   procedure Fake_Outer_Composite_Serialize
      (Client : in out Client_Type;
       ...
       Result : out Samples.Petstore.Models.OuterComposite_Type) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
      Reply : Swagger.Value_Type;
   begin
      ...
      URI.Set_Path ("/fake/outer/composite");
      Client.Call (Swagger.Clients.POST, URI, Req, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Fake_Outer_Composite_Serialize;
   ...
   procedure Fake_Outer_Number_Serialize
      (Client : in out Client_Type;
       ...
       Result : out Samples.Petstore.Models.OuterNumber_Type) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
      Reply : Swagger.Value_Type;
   begin
      ...
      URI.Set_Path ("/fake/outer/number");
      Client.Call (Swagger.Clients.POST, URI, Req, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Fake_Outer_Number_Serialize;
   ...
   procedure Fake_Outer_String_Serialize
      (Client : in out Client_Type;
       ...
       Result : out Samples.Petstore.Models.OuterString_Type) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
      Reply : Swagger.Value_Type;
   begin
      ...
      URI.Set_Path ("/fake/outer/string");
      Client.Call (Swagger.Clients.POST, URI, Req, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Fake_Outer_String_Serialize;

   --  
   procedure Test_Body_With_Query_Params
      (Client : in out Client_Type;
       P_Body : in Samples.Petstore.Models.User_Type;
       Query : in Swagger.UString) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin
      ...
      URI.Set_Path ("/fake/body-with-query-params");
      Client.Call (Swagger.Clients.PUT, URI, Req);
   end Test_Body_With_Query_Params;
   ...
   procedure Test_Endpoint_Parameters
      (Client : in out Client_Type;
       ...
       Callback : in Swagger.Nullable_UString) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin
      Client.Set_Accept ((Swagger.Clients.APPLICATION_XML; CHARSET=UTF_8,
                          Swagger.Clients.APPLICATION_JSON; CHARSET=UTF_8));
      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_FORM));
      Req.Stream.Write_Entity ("integer", Integer);
      Req.Stream.Write_Entity ("int32", Int32);
      Req.Stream.Write_Entity ("int64", Int64);
      Req.Stream.Write_Entity ("number", Number);
      Req.Stream.Write_Entity ("float", Float);
      Req.Stream.Write_Entity ("double", Double);
      Req.Stream.Write_Entity ("string", String);
      Req.Stream.Write_Entity ("pattern_without_delimiter", Pattern_Without_Delimiter);
      Req.Stream.Write_Entity ("byte", Byte);
      Req.Stream.Write_Entity ("binary", Binary);
      Req.Stream.Write_Entity ("date", Date);
      Req.Stream.Write_Entity ("dateTime", Date_Time);
      Req.Stream.Write_Entity ("password", Password);
      Req.Stream.Write_Entity ("callback", Callback);

      URI.Set_Path ("/fake");
      Client.Call (Swagger.Clients.POST, URI, Req);
   end Test_Endpoint_Parameters;
   ...
   procedure Test_Enum_Parameters
      (Client : in out Client_Type;
       ...
       Enum_Query_Double : in double) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.*_*));
      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_FORM));
      Req.Stream.Write_Entity ("enum_form_string_array", Enum_Form_String_Array);
      Req.Stream.Write_Entity ("enum_form_string", Enum_Form_String);
      Req.Stream.Write_Entity ("enum_query_double", Enum_Query_Double);

      URI.Add_Param ("enum_query_string_array", Enum_Query_String_Array);
      URI.Add_Param ("enum_query_string", Enum_Query_String);
      URI.Add_Param ("enum_query_integer", Enum_Query_Integer);
      URI.Set_Path ("/fake");
      Client.Call (Swagger.Clients.GET, URI, Req);
   end Test_Enum_Parameters;

   --  test inline additionalProperties
   procedure Test_Inline_Additional_Properties
      (Client : in out Client_Type;
       Param : in Samples.Petstore.Models.Swagger.Object) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin

      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_JSON));
      Samples.Petstore.Models.Serialize (Req.Stream, "", Param);

      URI.Set_Path ("/fake/inline-additionalProperties");
      Client.Call (Swagger.Clients.POST, URI, Req);
   end Test_Inline_Additional_Properties;

   --  test json serialization of form data
   procedure Test_Json_Form_Data
      (Client : in out Client_Type;
       Param : in Swagger.UString;
       Param2 : in Swagger.UString) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin

      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_FORM));
      Req.Stream.Write_Entity ("param", Param);
      Req.Stream.Write_Entity ("param2", Param2);

      URI.Set_Path ("/fake/jsonFormData");
      Client.Call (Swagger.Clients.GET, URI, Req);
   end Test_Json_Form_Data;
   ...
   begin
      ...
      URI.Set_Path ("/fake_classname_test");
      Client.Call (Swagger.Clients.PATCH, URI, Req, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Test_Classname;
   ...
   begin
      ...
      URI.Set_Path ("/store/order/{order_id}");
      URI.Set_Path_Param ("order_id", Order_Id);
      Client.Call (Swagger.Clients.DELETE, URI);
   end Delete_Order;
   ...
   begin
      ...
      URI.Set_Path ("/store/order/{order_id}");
      URI.Set_Path_Param ("order_id", Swagger.To_String (Order_Id));
      Client.Call (Swagger.Clients.GET, URI, Reply);
      Samples.Petstore.Models.Deserialize (Reply, "", Result);
   end Get_Order_By_Id;
