...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-02-16T16:42:11.462Z[Etc/UTC]")public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://raw.githubusercontent.com/v3";
  ...
  public ApiClient() {
    ...
    authentications.put("http_bearer_test", new OAuth());
