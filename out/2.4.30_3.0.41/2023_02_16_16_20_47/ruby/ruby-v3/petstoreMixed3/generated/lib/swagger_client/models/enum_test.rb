  ...
  class EnumTest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::EnumTest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::EnumTest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      enum_string_validator = EnumAttributeValidator.new('Object', ['UPPER', 'lower', ''])
      ...
      enum_number_validator = EnumAttributeValidator.new('Object', [1.1, -1.2])
    ...
    def enum_string=(enum_string)
      validator = EnumAttributeValidator.new('Object', ['UPPER', 'lower', ''])
