...
module SwaggerClient
  class PetApi
    ...
    def get_all_pets(opts = {})
      data, _status_code, _headers = get_all_pets_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(AllPetsResponse, Integer, Hash)>] AllPetsResponse data, response status code and response headers
    def get_all_pets_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PetApi.get_all_pets ...'
      end
      # resource path
      local_var_path = '/allPets'
      ...
      return_type = opts[:return_type] || 'AllPetsResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PetApi#get_all_pets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # Find pet by ID
    ...
    def get_random_pet(opts = {})
      data, _status_code, _headers = get_random_pet_with_http_info(opts)
      data
    end

    # @param [Hash] opts the optional parameters
    # @return [Array<(SinglePetResponse, Integer, Hash)>] SinglePetResponse data, response status code and response headers
    def get_random_pet_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PetApi.get_random_pet ...'
      end
      # resource path
      local_var_path = '/randomPet'
      ...
      return_type = opts[:return_type] || 'SinglePetResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PetApi#get_random_pet\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :additional_metadata 
