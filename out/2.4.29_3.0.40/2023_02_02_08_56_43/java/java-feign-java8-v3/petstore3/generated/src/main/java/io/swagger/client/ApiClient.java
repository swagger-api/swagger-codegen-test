...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-02-02T09:08:00.403Z[Etc/UTC]")public class ApiClient {
  public interface Api {}

  protected ObjectMapper objectMapper;
  private String basePath = "https://raw.githubusercontent.com/api/v3";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("api_key".equals(authName)) {
        ...
        auth = new OAuth(OAuthFlow.implicit, "https://petstore3.swagger.io/oauth/authorize", "", "write:pets, read:pets");
      } else {
