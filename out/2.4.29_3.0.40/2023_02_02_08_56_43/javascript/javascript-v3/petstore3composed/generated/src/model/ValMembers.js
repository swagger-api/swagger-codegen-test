...
* @version 1.0.0
*/
export default class ValMembers {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('val_member')) {
                obj['val_member'] = ApiClient.convertToType(data['val_member'], [OneOfvalMembersValMemberItems]);
            }
        }
        return obj;
    }
    ...
    * @member {Array.<Object>} val_member
    */
    'val_member' = undefined;
