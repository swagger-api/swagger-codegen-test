...
class PetApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ParrotBody1 $body body (optional)
     *
     ...
     * Add a new parrow to the store
     *
     * @param  \Swagger\Client\Model\ParrotBody1 $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function feedPetRequest($body, $token, $pet_type, $status, $pet_id, $session_id)
    {
        ...
        // query params
        if ($pet_type !== null) {
            $queryParams['petType'] = ObjectSerializer::toQueryValue($pet_type, null);
        }
        // query params
        if ($status !== null) {
     ...
     * update parrots
     *
     * @param  \Swagger\Client\Model\ParrotBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * update parrots
     *
     * @param  \Swagger\Client\Model\ParrotBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
