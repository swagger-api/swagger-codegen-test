...
public interface ParrotApi {
    ...
    ResponseEntity<InlineResponse2001> addParrot(@ApiParam(value = "" ) @Valid @RequestBody ParrotBody1 body);
    ...
    ResponseEntity<InlineResponse200> updateParrots(@ApiParam(value = "" ) @Valid @RequestBody ParrotBody body);
