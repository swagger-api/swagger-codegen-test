...
class ParrotApi(
  ...
  val helper = new ParrotApiAsyncHelper(client, config)
   ...
   */
  def addParrot(body: Option[ParrotBody1] = None): Option[inline_response_200_1] = {
   ...
   */
  def addParrotAsync(body: Option[ParrotBody1] = None): Future[inline_response_200_1] = {
   ...
   */
  def updateParrots(body: Option[ParrotBody] = None): Option[inline_response_200] = {
   ...
   */
  def updateParrotsAsync(body: Option[ParrotBody] = None): Future[inline_response_200] = {
      helper.updateParrots(body)
  }

}

class ParrotApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {

  def addParrot(body: Option[ParrotBody1] = None
    )(implicit reader: ClientResponseReader[inline_response_200_1], writer: RequestWriter[Option[ParrotBody1]]): Future[inline_response_200_1] = {
  ...
  def updateParrots(body: Option[ParrotBody] = None
    )(implicit reader: ClientResponseReader[inline_response_200], writer: RequestWriter[Option[ParrotBody]]): Future[inline_response_200] = {
    // create path and map variables
    val path = (addFmt("/parrot"))
