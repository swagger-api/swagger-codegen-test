...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2023-02-02T09:08:02.848Z[Etc/UTC]")
public class PetApi {
...
"read:pets"        })    }, tags={ "pet" })
    ...
    public Response addPet(@FormParam(value = "id")  Long id,@FormParam(value = "name")  String name,@FormParam(value = "category")  Category category,@FormParam(value = "photoUrls")  List<String> photoUrls,@FormParam(value = "tags")  List<Tag> tags,@FormParam(value = "status")  String status) {
        return Response.ok().entity("magic!").build();
    }
    @DELETE
    @Path("/{petId}")
...
"read:pets"        })    }, tags={ "pet" })
    ...
    public Response findPetsByStatus(  @QueryParam("status") @DefaultValue("available") 
...
"read:pets"        })    }, tags={ "pet" })
    ...
    public Response findPetsByTags(  @QueryParam("tags") 
...
"read:pets"        })    }, tags={ "pet" })
    ...
    public Response updatePet(@FormParam(value = "id")  Long id,@FormParam(value = "name")  String name,@FormParam(value = "category")  Category category,@FormParam(value = "photoUrls")  List<String> photoUrls,@FormParam(value = "tags")  List<Tag> tags,@FormParam(value = "status")  String status) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/{petId}")
