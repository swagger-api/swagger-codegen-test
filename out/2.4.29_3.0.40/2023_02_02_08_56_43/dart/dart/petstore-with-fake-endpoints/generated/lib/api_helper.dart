...
String parameterToString(dynamic value) {
  if (value == null) {
    ...
    return Boolean.encode(value).toString();
  } else if (value is EnumClass) {
    return EnumClass.encode(value).toString();
  } else if (value is Ints) {
    return Ints.encode(value).toString();
  } else if (value is Numbers) {
    return Numbers.encode(value).toString();
  } else if (value is OuterEnum) {
    return OuterEnum.encode(value).toString();
  } else {
